<section id="services" class="section">
      <div class="container">
        <div class="section-header">
          ...
          <p class="section-subtitle wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s ">Our loan products were carefully designed to meet the needs of all your business ventures. 
          <br> Your service is our honor and your satisfaction is our goal. </p>
        </div>
        <div class="row ">
          ...
          <div class="col-md-6 col-sm-6">
            <div class="item-boxes wow fadeInDown animated" data-wow-delay="0.8s" style="visibility: visible;-webkit-animation-delay: 0.8s; -moz-animation-delay: 0.8s; animation-delay: 0.8s;">
              ...
              <h4>EBDAA LOAN</h4>	
              <p>Ebdaa loan is a dedicated loan for men that starts at BD 200 and caps at BD 1000 based on men-owned home-business needs. The loan will help men grow their businesses and differenciate their products without the need for traditional collateral.</p>
          ...
          <div class="col-md-4 col-sm-6">
            <div class="item-boxes wow fadeInDown animated" data-wow-delay="1.2s" style="visibility: visible;-webkit-animation-delay: 1.2s; -moz-animation-delay: 1.2s; animation-delay: 1.2s;">
              ...
              <h4>Al AMAL LOAN</h4>
              <p>Al Amal loan is dedicated to borrowers who own a formal or informal business regardless of its nature (i.e. industrial, trading, or service) and regardless if  it is operated from home, mobile, or market-based. This loan also tailors for those who are ready to move from the informal to the formal sector. Loan ranges between BD 1000 and 2000 to be paid over 24 months. </p>
          ...
          <div class="col-md-4 col-sm-6">
            <div class="item-boxes wow fadeInDown animated" data-wow-delay="1.6s" style="visibility: visible;-webkit-animation-delay: 1.2s; -moz-animation-delay: 1.2s; animation-delay: 1.6s;">
              ...
              <p>Al Tamayuz Loan only tailors for businesses that are licensed. The purpose of this loan is to assist business owners to support thier working capital or purchase needed equipment. This loan ranges between BD 1500 to 5000 to be paid over 36 months. </p>
          ...
          <div class="col-md-4 col-sm-6">
            <div class="item-boxes wow fadeInDown animated" data-wow-delay="2s" style="visibility: visible;-webkit-animation-delay: 1.2s; -moz-animation-delay: 1.2s; animation-delay: 2s;">
              ...
              <p>Al Mawsimi Loan tailors for informal or formal business needs on specific seasons such as the holy month of Ramadan and Back-To-School seasons. The loan ranges between BD 100 and 800 and is paid over 10 months.</p>
		  ...
		  <div class="col-md-6 col-sm-6">
            <div class="item-boxes wow fadeInDown animated" data-wow-delay="2.4s" style="visibility: visible;-webkit-animation-delay: 1.2s; -moz-animation-delay: 1.2s; animation-delay: 2s;">
              ...
              <p>This loan is known for its flexibility. It is designed to meet the needs men or women with licensed businesses. It can also be provided to mobile businesses such as distribution and delivery businesses or even taxi owners. Al Tafawoq loan is an amount between BD 1000 and 5000 and can be paid over 6, 12, 18, 24, or 36 months. </p>
		  ...
		  <div class="col-md-6 col-sm-6">
            <div class="item-boxes wow fadeInDown animated" data-wow-delay="2.8s" style="visibility: visible;-webkit-animation-delay: 1.2s; -moz-animation-delay: 1.2s; animation-delay: 2s;">
              ...
              <h4>Al NAJAH LOAN</h4>
              <p>Al Najah Loan tailors for home-based businesses with credit needs and/or longer tenure than both Sayedati and Ebdaa Loans. This loan ranges between BD 600 and 1400 to paid over 18 months.</p>
