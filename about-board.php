...
<body>
    ...
    <div class="stuff-item leader" data-toggle="modal" data-target="#MonaModal">
        <div class="img-container">
            <img loading="lazy" src="assets/img/board/mona.web.png" alt="stuff img">
        </div>
        <div class="info-container">
            <h3>السيدة منى يوسف المؤيد</h3>
    ...
    <div class="stuff-container">
        <div class="d-flex justify-content-around flex-wrap">
            <div class="stuff-item" data-toggle="modal" data-target="#NasserModal">
                <div class="img-container">
                    <img loading="lazy" src="assets/img/board/nasser.web.png" alt="stuff img">
                </div>
                <div class="info-container">
                    <h3>الدكتور ناصر بكر القحطاني</h3>
                    <p>نائب رئيس مجلس الادارة</p>
                </div>
            </div>
            <div class="stuff-item" data-toggle="modal" data-target="#AbedModal">
                <div class="img-container">
                    <img loading="lazy" src="assets/img/board/abdelhamid.web.png" alt="stuff img">
                </div>
                <div class="info-container">
                    <h3>السيد عبدالحميد ديواني</h3>
                    <p>عضو مجلس ادارة</p>
                </div>
            </div>
            <div class="stuff-item" data-toggle="modal" data-target="#KhaledSalemModal">
                <div class="img-container">
                    <img loading="lazy" src="assets/img/board/khaled.web.png" alt="stuff img">
                </div>
                <div class="info-container">
                    <h3>السيد خالد على سالم</h3>
                    <p>عضو مجلس ادارة</p>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-around flex-wrap">
            <div class="stuff-item" data-toggle="modal" data-target="#BadrModal">
                <div class="img-container">
                    <img loading="lazy" src="assets/img/board/badr.web.png" alt="stuff img">
                </div>
                <div class="info-container">
                    <h3>د.بدرالدين عبدالرحيم</h3>
                    <p>عضو مجلس ادرة</p>
                </div>
            </div>
            <div class="stuff-item" data-toggle="modal" data-target="#DalalModal">
                <div class="img-container">
                    <img loading="lazy" src="assets/img/board/dalal.web.png" alt="stuff img">
                </div>
                <div class="info-container">
                    <h3>السيدة دلال احمد الغيص</h3>
                    <p>عضو مجلس ادارة</p>
                </div>
            </div>
            <div class="stuff-item" data-toggle="modal" data-target="#AbirModal">
                <div class="img-container">
                    <img loading="lazy" src="assets/img/board/abir.web.png" alt="stuff img">
                </div>
                <div class="info-container">
                    <h3>عبير البنعلي </h3>
                    <p>عضو مجلس ادارة</p>
    ...
    <div class="modal fade team-modal" id="MonaModal" tabindex="-1" role="dialog" aria-labelledby="MonaLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" dir="ltr">
                    <h5 class="modal-title" id="MonaLabelLabel">منى المؤيد - رئيس مجلس الادارة</h5>
    ...
    <div class="modal fade team-modal" id="DalalModal" tabindex="-1" role="dialog" aria-labelledby="DalalModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" dir="ltr">
                    <h5 class="modal-title" id="DalalModalLabel">السيدة دلال أحمد الغيص - عضو مجلس ادارة</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="إغلاق">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade team-modal" id="AbedModal" tabindex="-1" role="dialog" aria-labelledby="AdelModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" dir="ltr">
                    <h5 class="modal-title" id="AdelModalLabel">الأستاذ عبد الحميد دواني</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="إغلاق">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade team-modal" id="BadrModal" tabindex="-1" role="dialog" aria-labelledby="BadrModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" dir="ltr">
                    <h5 class="modal-title" id="BadrModalLabel">د. بدر الدين عبدالرحيم</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="إغلاق">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade team-modal" id="AbirModal" tabindex="-1" role="dialog" aria-labelledby="AbirModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" dir="ltr">
                    <h5 class="modal-title" id="AbirModalLabel">عبير البنعلي </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="إغلاق">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <p>السيدة عبير البنعلي لديها خبرة تمتد لأكثر من اثني عشر عامًا في مجال إدارة المخاطر داخل القطاع المصرفي. انضمت إلى البنك في عام 2012. تحمل السيدة البن علي درجة البكالوريوس في العلوم المصرفية والمالية من جامعة بانغور في المملكة المتحدة، وقد أنهت مؤخرًا درجة الماجستير في إدارة الأعمال (MBA) من الجامعة الأمريكية في البحرين عام 2024.</p>

                    <p>كما أنها حاصلة على عدة شهادات مهنية مرموقة، من بينها:</p>
                    <ul>
                        <li>المحلّل المالي المعتمد (CFA)</li>
                        <li>المدير التنفيذي المعتمد للمخاطر (CCRO)</li>
                        <li>مدير المخاطر المهني (PRM)</li>
                    </ul>

                    <p>بالإضافة إلى ذلك، تحمل دبلومًا دوليًا في الحوكمة والمخاطر والامتثال من معهد ICA، وقد تابعت أيضًا العديد من الشهادات المهنية الأخرى في مجالات القيادة، والإدارة، والحوكمة المؤسسية، والامتثال.</p>

                    <p>تشغل حاليًا منصب مساعد المدير العام - إدارة المخاطر في بنك الإسكان</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn" data-dismiss="modal">إغلاق</button>
                </div>
    ...
    <div class="modal fade team-modal" id="KhaledSalemModal" tabindex="-1" role="dialog" aria-labelledby="KhaledSalemModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" dir="ltr">
                    <h5 class="modal-title" id="KhaledSalemModalLabel">م. خالد علي سالم </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="إغلاق">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <p>يُعد المهندس خالد علي سالم قائدًا بارزًا في قطاع الأعمال ومستشارًا استراتيجيًا يتمتع بأكثر من عقدين من الخبرة في التمويل والاستثمار، التكنولوجيا و الاتصال، التصنيع و التجارة، وانتاج المواد الاستهلاكية الغذائية والتسويق.</p>

                    <h6>الخبرات القيادية</h6>
                    <p>عضو مجلس إدارة ومؤسس لشركة البحرين للاستشارات بي سي جسي إم، ومخبز جروتا، وشركة كيمادكس للحلول الكيميائية، قاد مشاريع استثمارية وصناعية وتجارية، مسهمًا في تعزيز النمو الاقتصادي والتوسع في الأسواق الإقليمية. كما يعمل مدربًا ومستشارًا في القيادة الاستراتيجية بمعهد البحرين للدراسات المصرفية والمالية، حيث يطور القادة التنفيذيين ويعزز الحوكمة المؤسسية.</p>

                    <h6>العضويات</h6>
                    <p>عضو في لجنة الأسواق التجارية بغرفة تجارة وصناعة البحرين، وله دور فاعل في وضع السياسات الاقتصادية وتنمية التجارة.</p>

                    <h6>المؤهلات العلمية</h6>
                    <p>يحمل ماجستير في إدارة الأعمال من جامعة ماليزيا المفتوحة وبكالوريوس في الهندسة الكيميائية والاقتصاد الصناعي من جامعة البحرين، إضافة إلى شهادات احترافية في تحليل الأعمال وإدارة المشاريع وعلوم البيانات.</p>

                    <h6>الجوائز والإنجازات</h6>
                    <p>حاصل على جوائز مرموقة تقديرًا لإسهاماته في ريادة الأعمال، الابتكار، والتنمية المستدامة، ويدعم برؤيته رسالة بنك الإبداع في تمكين الأفراد وتعزيز النمو الاقتصادي</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn" data-dismiss="modal">إغلاق</button>
                </div>
