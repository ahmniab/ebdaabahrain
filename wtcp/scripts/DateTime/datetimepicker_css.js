...
{ //Generate table cell with value
	...
	if (PValue !== "")
	{
		if (PClickable === true) {
		    ...
		    { PCellStr = "\n<td id='c" + PValue + "' " + vColor + " class='calTD' style='cursor:pointer;' onmousedown='selectDate(this," + PValue + ");'>" + PValue + "</td>"; }
		    else
		    { PCellStr = "\n<td " + vColor + " class='calTD' style='cursor: pointer;' onmouseover='changeBorder(this, 0);' onmouseout=\"changeBorder(this, 1, '" + pColor + "');\" onClick=\"javascript:callback('" + Cal.Ctrl + "','" + Cal.FormatDate(PValue) + "');\">" + PValue + "</td>"; }


		}
		else
		{
			PCellStr = "\n<td " + vColor + " class='calTD' >" + PValue + "</td>";
		}
	}
	else
	{
...
function RenderCssCal(bNewCal)
{
	...
	vCalHeader = "<table background='" + ThemeBg + "' style=\"background-color:" + CalBgColor + "; border:1px solid #000000;width:200px;padding:4px;\"><tbody>";

	//Table for Month & Year Selector

	vCalHeader += "<tr><td colspan='7'><table border='0' width='200px' cellpadding='0' cellspacing='0'>\n<tr>\n";
	...
	vCalHeader += "<tr><td colspan=\"7\"><table cellspacing=1 style=\"border-spacing:1px;\"><tr>\n";
...
function selectDate(element, date) {
    //var prev_cell = document.getElementById("c" + Cal.Date);
    //prev_cell.style.background = prev_cell.bgColor;
