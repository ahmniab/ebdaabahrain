<header id="hero-area" data-stellar-background-ratio="0.5">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block">
              ...
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">Up to 5,000 BD. </p>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
            <div class="facts-item">
			  ...
			  <!-- end of counter -->
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">Ebdaa Bank ... step by step with you  </p>
		...
		<div class="carousel-item">
            ...
            <div class="carousel-caption d-none d-md-block">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">Ebdaa Bank is SDGs oriented</h1>
