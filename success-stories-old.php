...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a href="en.php" class="navbar-brand">
            <div id="lang-switch"><i class="fa-solid fa-language"></i> &nbsp; English </div>
        </a>
        <ul class="navbar-nav mr-auto">
            <li class="nav-item"><a class="nav-link page-scroll" href="index.php#services">منتجاتنا</a></li>
            <li class="nav-item"><a class="nav-link page-scroll" href="index.php#application">ترغب في الحصول على قرض؟</a></li>
            <li class="nav-item"><a class="nav-link page-scroll" href="index.php#portfolios">قصص النجاح </a></li>
            <li class="nav-item"><a class="nav-link page-scroll" href="index.php#team">فريق العمل </a></li>
            <li class="nav-item"><a class="nav-link page-scroll" href="index.php#blog">اخبارنا</a></li>
            <li class="nav-item"><a class="nav-link page-scroll" href="about-us.php">من نحن </a></li>
            <li class="nav-item"><a class="nav-link page-scroll" href="index.php#contact">اتصل بنا</a></li>
        </ul>
        <div class="collapse navbar-collapse" id="navbarContent">
        </div>
        <a href="index.php" class="logo">
            <img src="assets/img/logo_arabic_gray_old.png" alt="">
        </a>
    </nav>
    <!-- Navbar End  -->
            ...
            <div class="container">
                <div class="section-header">
                    ...
                    <p class="section-subtitle">
                        ...
                        اكتشف تجارب الناجحين معنا
                    </p>
                </div>

                <!-- Filter Controls -->
                <div class="stories-controls">
                    <a class="stories-filter active" data-filter="all">
                        الكل
                    </a>
                    <a class="stories-filter" data-filter=".stories">
                        قصص النجاح
                    </a>
                    <a class="stories-filter" data-filter=".stories_video">
                        قصص النجاح المصورة
                    </a>
                </div>
                ...
                <div class="row" id="portfolio">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4 mix stories_video">
                        <div class="story-card">
                            <div class="story-image">
                                <img src="assets/img/story/story_1.jpg" alt="وهيبه خليل">
                                <div class="video-indicator">
                                    <i class="fa fa-play"></i>
                                </div>
                                <a class="story-overlay" data-target="#story_1" data-toggle="modal" href="#">
                                    <h3 class="story-name">وهيبه خليل</h3>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4 mix stories">
                        <div class="story-card">
                            <div class="story-image">
                                <img src="assets/img/story/story_4.jpg" alt="محمد عباس">
                                <a class="story-overlay" data-target="#story_4" data-toggle="modal" href="#">
                                    <h3 class="story-name">محمد عباس</h3>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4 mix stories_video">
                        <div class="story-card">
                            <div class="story-image">
                                <img src="assets/img/story/story_3.jpg" alt="فاطمة محمد علي">
                                <div class="video-indicator">
                                    <i class="fa fa-play"></i>
                                </div>
                                <a class="story-overlay" data-target="#story_3" data-toggle="modal" href="#">
                                    <h3 class="story-name">فاطمة محمد علي</h3>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4 mix stories_video">
                        <div class="story-card">
                            <div class="story-image">
                                <img src="assets/img/story/story_5.jpg" alt="سوسن محمد">
                                <div class="video-indicator">
                                    <i class="fa fa-play"></i>
                                </div>
                                <a class="story-overlay" data-target="#story_5" data-toggle="modal" href="#">
                                    <h3 class="story-name">سوسن محمد</h3>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4 mix stories">
                        <div class="story-card">
                            <div class="story-image">
                                <img src="assets/img/story/story_7.jpg" alt="عيسى علي">
                                <a class="story-overlay" data-target="#story_7" data-toggle="modal" href="#">
                                    <h3 class="story-name">عيسى علي</h3>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4 mix stories">
                        <div class="story-card">
                            <div class="story-image">
                                <img src="assets/img/story/story_9.jpg" alt="حميد عيد">
                                <a class="story-overlay" data-target="#story_9" data-toggle="modal" href="#">
                                    <h3 class="story-name">حميد عيد</h3>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4 mix stories">
                        <div class="story-card">
                            <div class="story-image">
                                <img src="assets/img/story/story_10.jpg" alt="حمد شبيب">
                                <a class="story-overlay" data-target="#story_10" data-toggle="modal" href="#">
                                    <h3 class="story-name">حمد شبيب</h3>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4 mix stories">
                        <div class="story-card">
                            <div class="story-image">
                                <img src="assets/img/story/story_6.JPG" alt="أحمد جوهر">
                                <a class="story-overlay" data-target="#story_6" data-toggle="modal" href="#">
                                    <h3 class="story-name">أحمد جوهر</h3>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4 mix stories">
                        <div class="story-card">
                            <div class="story-image">
                                <img src="assets/img/story/story_2.jpg" alt="ساهرة إبراهيم">
                                <a class="story-overlay" data-target="#story_2" data-toggle="modal" href="#">
                                    <h3 class="story-name">ساهرة إبراهيم</h3>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4 mix stories_video">
                        <div class="story-card">
                            <div class="story-image">
                                <img src="assets/img/story/story_8.png" alt="حسن محمد">
                                <div class="video-indicator">
                                    <i class="fa fa-play"></i>
                                </div>
                                <a class="story-overlay" data-target="#story_8" data-toggle="modal" href="#">
                                    <h3 class="story-name">حسن محمد</h3>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    <div class="modal-body ar-txt">
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-common" data-dismiss="modal" style="visibility: visible; -webkit-animation-duration: 1000ms; -moz-animation-duration: 1000ms; animation-duration: 1000ms;" type="button">إغلاق</button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="box_shadow">
                                    ...
                                    <p>اقترضت ساهرة من أبداع البحرين 600 دينار لتطوير مشروعها من خلال شراء التجهيزات اللازمة للتوسع في المشروع وتنمية أرباحه، ومن بين تلك التجهيزات فرن جديد وأجهزة كهربائية.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="box_shadow">
                                    ...
                                    <p>مؤخرا أراد حسن توسعة مشروعه وإضافة نشاط جديد له وهو تربية الأغنام، وهو ممتن الآن لمبادرة أبداع البحرين في دعمه بجزء من المبلغ اللازم للانطلاق في النشاط الجديد ومساعدته في تحقيق أهدافه وزيادة إنتاجيته.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            // Debug: Check if modals are working
            ...
            // Alternative modal trigger for story overlays
            $('.story-overlay').on('click', function(e) {
                e.preventDefault();
                var target = $(this).data('target');
                console.log('Story overlay clicked:', target);
                $(target).modal('show');
            });
