...
<td align="right" bgcolor="#eeeeee">Sections</td>
</tr>
<tr>
<td colspan="3" align="right">&nbsp;&nbsp;
<input name="Clear All" type="button" id="Clear All" onClick="selectAllCheckBoxes('update_active', 'checkbox[]', false);" value="DeSelect All">
...
<td width="62" align="right" bgcolor="#eeeeee">Select</td>
</tr>
<tr>
<td width="535" align="right">&nbsp;&nbsp;</td>
<td width="79" align="right">&nbsp;</td>
<td align="right" bgcolor="#66CC66"><input name="insert" type="submit" id="insert" value="Insert data"></td>
<td align="right" bgcolor="#eeeeee">الخيارات</td>
</tr>
<tr>
<td colspan="3" align="right" class="marktext"><?php echo $upload_DIE_image;?></td>
<td align="right">Section Folder</td>
</tr>
<tr>
