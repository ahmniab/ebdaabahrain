          ...
          <div class="col-md-12">
			...
			<div class="testimonial-item ">
                ...
                <div class="testimonial-text">
                  <p> <span class="fa fa-quote-left"></span> &nbsp The objective of Ebdaa Bank is to serve Bahrainis who run small businesses or intend to start ones,  <br> all in order to achieve the Bahrain Economic Vision 2030 and the 17 sustainable development goals of the United Nations, <br> whom Bahrain volunteered to implement &nbsp <span class="fa fa-quote-right"></span> </p>
              ...
              <div class="testimonial-item ">
                ...
                <div class="testimonial-text ">
                  <p><span class="fa fa-quote-left"></span>&nbsp During my years at Ebdaa Bank, I found that <br>   Bahraini women are the best example of hard work and creativity,<br>and always strive to rely on themselves and manage their work &nbsp <span class="fa fa-quote-right"></span></p>
