    ...
    <header id="hero-area" data-stellar-background-ratio="0.5">
     ...
     <div >
         ...
         <div class="col-sm-12 col-md-12 col-lg-12">
              <h4 class="job-header">Apply for a JOB</h4>
              </div>
         </div>
	  </header>
     <body >
...
<script type=’text/javascript’ src=’https://www.google.com/recaptcha/api.js?;ver=2.0′></script>
            	...
            	<p style="color:black;" >**To view MAIN PAGE again <a href="en.php" target="_blank" style="color:#61D2B4"><b>please click here</b></a>.
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-sm-6 col-xs-12">
            <div class="copyright">
              <p>All copyrights reserved &copy; 2018 - Designed & Developed by <a rel="nofollow" href="en.php">Ebdaa Bank</a><br>Licensed as a Conventional MFI by the Central Bank of Bahrain</p>
            </div>
          </div>
          <!-- Footer Links -->
          <div class="col-lg-6 col-sm-6 col-xs-12">
            <ul class="footer-links ">
              ...
              <li><a href="job_application_en.php" target="_blank">Careers</a></li>
