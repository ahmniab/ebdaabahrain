<section id="contact" class="section" style="background-image: linear-gradient(#b1e9da, #ffffff);">
      <div class="container">
        <div class="section-header">
          ...
          <p class="section-subtitle wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s"> If you have any inquiries or complaints related to the services of Ebdaa Bank, please contact us using the form below. <br>Your opinion is important to us and your satisfaction is our goal. </p>
        </div>
          ...
          <div class="container">
            <div class="row ">
              <div class="col-lg-6 col-sm-12 col-xs-12" style="padding:0 !important">
				  ...
				  <div class="col-lg-5 col-sm-6 col-xs-12 contactBox" style="float: left !important; border-bottom: 2px solid #61D2B4">
                      ...
                      <ul style="text-align:left ;padding-bottom:10px;">
                       ...
                       <li> <a class="btn-rm" href="mailto:info@ebdaabank.com" > <span class="fa fa-envelope " style="padding-right:5px;" ></span>info@ebdaabank.com </a></li>
                    ...
                    <div class="col-lg-7 col-sm-6 col-xs-12 contactBox" style="float: left !important; border-bottom: 2px solid #61D2B4; border-left: 2px solid #61D2B4">
                      ...
                      <ul style="text-align:left; padding-bottom:10px">
                        ...
                        <li><a class="btn-rm" href="mailto:almanama@ebdaabank.com" > <span class="fa fa-envelope " style="padding-right:5px;" ></span>almanama@ebdaabank.com </a></li>
                        <li><a class="btn-rm"href="https://goo.gl/maps/M64LjU9m4v32" target="_blank"><i class="fa fa-map-marker fa-2x" style="padding-right:5px;"></i>Manama - Bahrain</a></li>
                      </ul>
                    </div>
                    ...
                    <div class="col-lg-5 col-sm-6 col-xs-12 contactBox" style="float: left !important; ">
                      ...
                      <ul style="text-align:left ;padding-bottom:10px;">
                        ...
                        <li><a class="btn-rm" href="mailto:aali@ebdaabank.com" > <span class="fa fa-envelope " style="padding-right:5px;" ></span>aali@ebdaabank.com </a></li>
                    ...
                    <div class="col-lg-7 col-sm-6 col-xs-12 contactBox" style="float: left !important; border-left: 2px solid #61D2B4">
                      ...
                      <ul style="text-align:left;padding-bottom:10px;">
                        ...
                        <li> <a class="btn-rm" href="mailto:hamad.town@ebdaabank.com" > <span class="fa fa-envelope " style="padding-right:5px;" ></span>hamad.town@ebdaabank.com </a></li>
        ...
        <p class="">** If you have any complaint, you can send a message via <a href="#contact" class="btn-link" style="color:#61D2B4"><b> the above form </b></a>or please follow the <a href="#" class="btn-link" data-toggle="modal" data-target="#complain" style="color:#61D2B4"><b> complaints procedure </b></a>and we will contact you.</p>
		    <p class="">** To view JOB VACANCIES please<a href="job_application_en.php" target="_blank" class="btn-link"  style="color:#61D2B4"><b> click here.</b></a></p>
        <!-- complain Modal -->
            ...
            <div class="modal-content">
              <div class="modal-body">
                ...
                <div class="col-sm-12">
                  ...
                  <hr>
                  <p>Ebdaa Bank for Microfinance undertakes to provide the highest level of service to its clients. Please let us know if our services do not meet your expectations in any way so that we can satisfy you</p>
                  ...
                  <div class="col-sm-12 col-md-6">
                    <div class="box_shadow">
                      ...
                      <p> Or email complaints@ebdaabank.com </p>
                    </div>
                  </div>
                  <div class="col-sm-12 col-md-6">
                    <div class="box_shadow" >
                      ...
                      <p> the complaint will be submitted to the Operations Department at Ebdaa Bank</p>
                    </div>
                  </div>
                  <div class="col-sm-12">
                    <div class="box_shadow" >
                      <p><b>Third, Follow-up Department at the Central Bank of Bahrain</p></b>
                      <p>If there is no solution to the issue of the complaint through Ebdaa Bank, you may refer the matter to the CBB Follow-up Department at the following Address:</p>
