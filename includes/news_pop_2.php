          ...
          <div class="modal-body ">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
				...
				<h4>Ebdaa Bank Prepared for Home Business Guide</h4>
                <hr>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block w-75" src="assets/img/news/news_20.jpg" alt="First slide">
			  ...
			  <p> Ebdaa Bank for Microfinance is prepared for the release of the Guide for Home-based Entrepreneurs following the directives of HRH Prince Salman bin Hamad Al Khalifa, Crown Prince, Deputy Supreme Commander and First Deputy Prime Minister.</p>
			  <p>CEO of Ebdaa Bank for Microfinance, Dr. Khalid Al Ghazzawi, praised the directives of HRH and confirmed the preparedness of Ebdaa Bank, supported by the Arab Gulf Development Program (AGFUND), to create the guide and assist home-based entrepreneurs in effectively utilizing it. A large segment of Ebdaa Bank’s clients are home-based entrepreneurs who borrow funds to grow their projects.</p>
			  <p>“The increasing trend towards home projects in Bahrain may result in security and safety risks. As part of its national role in adopting and implementing Bahrain’s Economic Vision 2030, Ebdaa Bank is fully prepared to contribute to the formulation of this guide while supporting the efforts of the Ministry of Labour and Social Development and the Ministry of Health,” said Dr. Al Ghazzawi.</p>
			  <p>Given its area of expertise which includes assisting Bahraini entrepreneurs and financing micro and small projects, Ebdaa Bank has the ability to largely contribute to the creation of the guide along with government officials. “We welcome the initiative and are pleased to fulfill this responsibility through our accumulated experience with home projects in the Kingdom of Bahrain and in the nine Arab countries where the banks of AGFUND operate,” he said.</p>
			  <p>“We will stress the urgency of appropriate security and safety systems to our customers for their projects, and the need to rely on equipment that automatically stops in the event of a short circuit or gas leak,” he concluded.</p>
			  <p>Ebdaa Bank was established in 2009 as the first microfinance bank in the Kingdom of Bahrain through the support of HRH Princess Sabeeka Bint Ibrahim Al Khalifa, the wife of the King of Bahrain and the President of the Supreme Council for Women, and the Late Prince Talal Bin Abdul Aziz Al Saud, the President of the Arab Gulf Programme for Development (AGFUND).</p>
			   </div>
              </div>
            </div>
          </div>
        ...
        <div class="modal-content">
          <div class="modal-body ">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
				<h4>The private sector is a key beneficiary of sustainable development: Dr. Al-Ghazawi</h4>
                <hr>
        ...
        <a class="carousel-control-next" href="#slides_News19" role="button" data-slide="next">
          <span class="carousel-control-next-icon" aria-hidden="true"></span>
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
               ...
               <div class="box_shadow" >
			  <p> CEO of Ebdaa Bank - Bahrain Dr. Khaled Al-Ghazzawi stressed that private sector is the first beneficiary for adopting SDGs, that because adopting SDGs will be returning the favor to the community through the creating qualified cadres capable of producing, increasing returns and raising performance levels.</p>
			  <p>During a regional workshop in Cairo organized by the Arab Network of NGOs in partnership with the Arab Gulf Development Program "AGFUND", Dr. Ghazzawi added that all government must adopt the sustainable economic and social development. He stressed that achieving the SDGs can be achieved with concerted efforts of the world as a whole to help each other.</p>
			  <p>“Towards a value system supportive of sustainable development” workshop was attended by about 50 participants from the Arab region and the world. During which, Dr. Al Ghazzawi has reviewed the achievements of the Kingdom of Bahrain in implementing SDGs, where The National Information Committee monitors the objectives of SDGs and its indicators, and links them to the government's work programs.</p>
			  <p>Dr. Al-Ghazzawi praised Bahrain's keenness on sustainable development as a basis for the government to develop its policies.</p>
			  <p>In this context, he referred to His Majesty king hamad youth empowerment award to achieve the SDGs, Princess Sabeeka Bint Ibrahim Al Khalifa Global Award for Women's Empowerment, and HRH Prince Khalifa Bin Salman Award for Sustainable Development".</p>
			  <p>Also, Dr. Al-Ghazzawi explained that the SDGs are implemented through the government's work programs in partnership with the private sector and civil society. The current program includes six strategic axes that intersect with key areas of SDGs. The comparison showed that 78% of the SDGs are included in the current program.</p>
			  <p>Dr. Al-Ghazzawi revealed that the workshop is the first step to the framework of the research project "Arab Code for Sustainable Development” adopted by AGFUND, Which aims to prepare an Arab code for sustainable development that includes a system of supporting values, a guide for NGOs for sustainable behavior, and a set of training programs and manuals that will build capacities and skills for NGOs to maximize their contribution to the implementation of sustainable development.</p>
			  <p>The workshop was attended by representatives of a number of NGOs and civil society organizations from the Arab world, including a number of prominent Arab economic figures, including Dr. Ziad Bahaa El Din, former Egyptian Deputy Prime Minister, Dr. Osman Mohamed Osman, former Egyptian Minister of Planning, and Dr. Ibrahim Awad, head of the refugee program at the American University in Cairo.
                    </p>
			   </div>
              </div>
            </div>
        ...
        <div class="modal-content">
          <div class="modal-body">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
				<h4>Ebdaa Bank for Micro Finance signs agreement with Shariyah Review Bureau (SRB)</h4>
                <hr>
                  <div id="slides_News18" class="carousel slide" data-ride="carousel">
        <ol class="carousel-indicators">
          <li data-target="#slides_News18" data-slide-to="0" class="active"></li>
          <li data-target="#slides_News18" data-slide-to="1"></li>
          <li data-target="#slides_News18" data-slide-to="2"></li>
        </ol>
        <div class="carousel-inner">
          <div class="carousel-item active">
        ...
        <a class="carousel-control-next" href="#slides_News18" role="button" data-slide="next">
          <span class="carousel-control-next-icon" aria-hidden="true"></span>
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
               ...
               <div class="box_shadow" >
			  <p>Ebdaa Bank for Microfinance has signed an agreement with the Shariyah Review Bureau (SRB) in Bahrain to ensure that the Bank's financial products comply with Shariah requirements.</p>
			  <p>Chief Executive of Ebdaa Bank, Dr. Khalid Al Ghazzawi stated that the agreement will further enhance the Bank's ability to adopt the best practices in this field. “This agreement is in line with the Bank's initiative to expand its range of financial products to not only include loans for low-income and micro-entrepreneurs, but also to those looking for Shariah-compliant financing,” sair Dr. Al Ghazzawi.</p>
			  <p>"More attention will be paid to the design of Shariah-compliant products that meet the expectations of our clients, with due regard to the proper application of Shariah principles and guidelines to microfinance operations," he added.  </p>
			  <p>Although Ebdaa Bank will be extending its range of services to include Shariah- compliant financing, it will continue to provide traditional loans to customers seeking conventional financing.</p>
			  <p>Operations Manager of Ebdaa Bank, Ghaith Al Moneim, stated that the Bank will work with SRB to implement a range of ambitious Islamic financial initiatives. "These guidelines will not only be in line with Shariah principles, but also with the Bank's vision and objective to support low income individuals,” said Mr. Al Moneim.</p>
			  <p>“We also intend to continue to assist them in their transition to self-employment and ensure their sustainability and prosperity, through the development of their businesses and projects,” he added.</p>
			  <p>Chief Executive Officer of SRB, Yasir Dahlawi, stated that he agreement with Ebda Bank for Microfinance supports the joint approach of the two parties towards the development of the Kingdom’s society and economy. “This agreement is also in line with our aim to support the progress of low-income families, facilitating the empowerment of women and the youth, and leading the transformation of ideas for small projects into key economic activities,” said Mr. Dahlawi.</p>
			  <p>He expressed his elation in welcoming Ebdaa Bank for Micro Finance to the SRB’s list of investors, institutions, Islamic banks and Takaful companies. “We are committed to working with Ebdaa Bank to achieve the common objectives of both parties,” he said.
                The Shariyah Review Bureau (SRB) is the only Shariah advisory firm in Bahrain licensed by the Central Bank of Bahrain. “Our services and approach has helped our firm succeed by building a global platform that covers over 17 countries and helps improve the services of the Sharia Supervisory Board,” he concluded.
                    </p>
			   </div>
              </div>
            </div>
        ...
        <div class="modal-content">
          <div class="modal-body">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
				<h4>Financial Results 2018 for Ebdaa Bank</h4>
                <hr>
        ...
        <a class="carousel-control-next" href="#slides_News17" role="button" data-slide="next">
          <span class="carousel-control-next-icon" aria-hidden="true"></span>
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
               ...
               <div class="box_shadow" >
			   <p>Ebdaa Bank reported net profits exceeding BD 306,000 for the financial year ended December 31, 2018, compared to a profit of BD 94,000 in 2017. The increase in net profits is reported to be due to the increase in the volume of operations apart from the number and value of disbursed loans. Operating as a social business, Ebdaa Bank confirmed that profits will be re-injected into the bank’s capital to increase the number and value of low-income loans, helping more Bahrainis to start and/or improve their micro and small businesses and serving the national economy in accordance with the Bahrain 2030 Vision.</p>
			   <p>In its statement on the performance of 2018, Ebdaa Bank reported that its assets increased by over 24% from around BD 2.45 million in 2017 to over BD 3.05 million at the end of 2018. The net loan portfolio increased from BD 1.6 million in 2017 to approximately BD 2.1 million in 2018, an increase of 31%. While the bank’s operational income increased by 40% in 2018, the Bank managed to control its operating expenses, which only increased by 10.7% in 2018, compared to 2017.</p>
			   <p>Ebdaa Bank successfully recovered nearly BD 64,000 from the provision for doubtful debts, as a result of increased efforts in the collection of outstanding loans and arrears from previous years.</p>
			   <p>Chairwoman of the Board of Directors of Ebdaa Bank, Mrs. Mona Yousef Al Moayyed, expressed her satisfaction with the continued development of the Bank’s operations and commitment to serve low-income Bahraini clients.“Enhancing the bank’s ability to lend is very important, at this time, as it contributes to national efforts to encourage retirees of the voluntary retirement program to launch their own businesses,” said Ms. Al Moayyed.</p>
			   ...
			   <p>Chief Executive Officer of Ebdaa Bank, Dr. Khalid Al-Gazawi stated that the fruitful results achieved over the past four years by Ebdaa Bank are mainly due to the implementation of AGFUND methodologies and standards in the field of microfinance. “Ebdaa Bank has become an example in the success of microfinance institutions in Bahrain and the rest of the region,” said Dr. Al- Ghazzawi.</p>
			   ...
			   <p>Ebdaa Bank was able to disburse over 2,600 loans to its new and repeat customers, amounting to over BD 2.6 million, in 2018. “The bank’s plan for the next five years focuses on serving 10,000 borrowers including existing and new customers with loans worth over BD 10 million,” he stated.</p>
			   <p>“The plan also includes the opening of branches in Muharraq, Saar and Sitra,” he added.
                 Dr. Al-Gazawi thanked the shareholders and all partners for their cooperation with Ebdaa Bank. “The Arab Gulf Development Program also plays a tremendous role in supporting the bank through the AGFUND model in financial management, which led to the Bank’s success in overcoming challenges faced since its establishment. We are highly pleased with this advanced stage of success,” he concluded.</p>
			   </div>
              </div>
            </div>
          </div>
        ...
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
				<h4>Ebdaa Bank plans to adopt technology solutions: CEO</h4>
                <hr>
        ...
        <div class="modal-content">
          <div class="modal-body ">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
				<h4>Ebdaa Bank offers vacancies  </h4>
                <hr>
            ...
            <img class="d-block w-75" src="assets/img/news/news_vacancies.jpg" alt="First slide">
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
               ...
               <div class="box_shadow" >
                ...
                <p>Manama, Feb. 24 (BNA): Ebdaa Bank for Microfinance in Bahrain has participated in the Pre-Work Education and Training Expo, which was held under the patronage of Labour and Social Development Minister Jameel bin Mohammed Ali Humaidan.</p>
				...
				<p>Chief Executive Officer of Ebdaa Bank, Dr.Khalid Al Ghazzawi, stated that Ebdaa Bank offered a number of vacant positions in various departments and fields, during the exhibition. "We received several applications for employment, during the exhibition, which we are reviewing," he said.</p>
				...
				<p>He stressed Ebdaa Bank’s interest in participating in such exhibitions and events in order to attract young Bahraini talent, while providing them with training opportunities and quality employment. "This is in line with Ebdaa Bank's keen interest in raising the percentage of Bahrainis in all our departments, which has currently reached over 80%," he stated.</p>
        ...
        <div class="modal-content">
          <div class="modal-body ">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
				<h4>BDB CE joins Ebdaa Bank’s director board </h4>
                <hr>
            ...
            <img class="d-block w-75" src="assets/img/news/news_Sanjev.jpg" alt="First slide">
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
               ...
               <div class="box_shadow" >
                ...
                <p>Ebdaa Bank Bahrain for micro-financing said the Chief Executive of Bahrain Development Bank (BDB) has become a member of the Edbaa Bank board of directors. BDB Chief Executive, Sanjeev Paul, is the successor of Dalal Ismail, who was a BDB representative in the board for over five years. </p>
				<p>Ebdaa Bank Bahrain Chairwoman, Mona Yousif Almoayyed, welcomed Paul, who has over 30 years of experience in the banking sector. “The membership will contribute to enhancing co-operation between the banks, both of which work to provide affordable loans for start-up projects and to support the national economy,” said Almoayyed. </p>
				...
				<p>“It will also help him adopt concepts of development in banking during his service as BDB chief executive,” she said. Almoayyed said Ebdaa Bank is keen to coordinate with BDB through Paul. “This is especially to transfer Ebdaa Bank’s clients who expand their projects, and require loans that are higher than the bank loans’ ceiling of BD5000, to BDB,” she stated.</p>
        ...
        <div class="modal-content">
          <div class="modal-body ">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
				<h4>UN office sign statement with Ebdaa Bank</h4>
                <hr>
          ...
          <span class="carousel-control-next-icon" aria-hidden="true"></span>
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
               ...
               <div class="box_shadow" >
				...
				<p>The signing ceremony was held at United Nations House in the presence of Dr. Khaled Al-Ghazawi, Chief Executive of Ebdaa Bank, and Amin Al-Sharkawi, United Nations Resident Coordinator and United Nations Development Programme Resident Representative, in addition to officials from both sides.</p>
        ...
        <div class="modal-content">
          <div class="modal-body ">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
				<h4>Algosaibi Holding Group Sign Grant Agreement in support of Ebdaa Bank</h4>
                <hr>
          ...
          <span class="carousel-control-next-icon" aria-hidden="true"></span>
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
               ...
               <div class="box_shadow" >
                ...
                <p>Algosaibi Holding Group has signed a grant agreement with Ebdaa Bank, as a nonprofit social financing, that seek to help low-income Bahraini make their way to business.</p>
                ...
                <p>The agreement was signed by Dr Khalid Al Ghazawi, CEO of Ebdaa Bank, and Mr Fawaz Algosaibi, CEO of Algosaibi Holding, at the  headquarter of Ebdaa Bank in Sanabis.</p>
                <p>“We grant five types of loans without guarantees to low-income Bahrainis in Ebdaa Bank, including Sayidati loan to finance projects run by housewives, in addition to other financing products that suits each borrowers’ project,”. Dr Al Ghazawi said.</p>
                ...
                <p>Mr. Algosaibi praised the efforts made by Ebdaa Bank to provide easy financing for low-incomers and prudent management practices implemented by the Bank, which contributed to its financial stability and the constant expansion of borrowers. </p>
        ...
        <div class="modal-content">
          <div class="modal-body ">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
				<h4>Ebdaa bank- Bahrain Launches New Products</h4>
                <hr>
          ...
          <div class="carousel-item active">
            <img class="d-block w-75" src="assets/img/news/news_2.jpg" alt="First slide">
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
               ...
               <div class="box_shadow" >
                 <p>Ebdaa Bank, for Microfinance, has launched two new loans “Al Najah” and “Altafawq”, offering more financial unguaranteed loans for Bahraini low-incomers.</p>
                 ...
                 <p>“We are branding Ebdaa Bank as an integral part of the lives of our customers. By launching “Alnajah” and “Altafawq” loans we are expanding our borrowers list which currently has 2,500. The amount of loans between BD200 to 5000, while the average single loan outstanding amount is BD 89,” Said Dr Khalid Al Ghazawi, the CEO of Ebdaa Bank.</p>
                 ...
                 <p>“We at Ebdaa Bank are part of the economic system in the Kingdom of Bahrain. We must keep pace with the development of this system and be pioneers in our business of providing unguaranteed microcredit to support economic growth."</p>
        ...
        <div class="modal-content">
          <div class="modal-body ">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
				<h4>Ebdaa Bank to Reopen Hamad Town Branch</h4>
                <hr>
        ...
        <a class="carousel-control-next" href="#slides_News3" role="button" data-slide="next">
          <span class="carousel-control-next-icon" aria-hidden="true"></span>
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
               ...
               <div class="box_shadow" >
                 <p>Ebdaa Bank for Microfinance will reopen its branch in Hamad Town after a comprehensive maintenance and development process, ensuring to improve convenience for existing customers of the bank and allow for serving additional residents seeking doing business with a local, community bank.</p>
                 ...
                 <p>“Decision to open a branch location in Hamad Town will improve convenience for existing customers of the bank and allow for serving 2000 residents at Hamad Town and the nearby villages” said Ebdaa Bank CEO Dr Khalid Waleed Al Ghazawi</p>
                 ...
                 <p>Ebdaa Bank is planning to establish more branches in Bahrain’s governorates, with the aim of expanding the bank's clientele and staying close to them, allowing Ebdaa Bank to study the requirements of a greater number of microcredit needs in different regions.</p>
                 <p>Ebdaa Bank for Microfinance opened its doors to customers in 2009, currently serving them through three main offices; its headquarters at Sanabis, Riyadat Mall branch at A’ali and Hamad Town branch. </p>
        ...
        <div class="modal-content">
          <div class="modal-body ">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
				<h4>Ebdaa Bank celebrated staff honouring</h4>
                <hr>
        ...
        <div class="modal-content">
          <div class="modal-body ">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
				<h4>Ebdaa Bank – Bahrain Attends “Middle East Investment Conference” in Cairo</h4>
                <hr>
        ...
        <a class="carousel-control-next" href="#slides_News5" role="button" data-slide="next">
          <span class="carousel-control-next-icon" aria-hidden="true"></span>
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
               ...
               <div class="box_shadow" >
                 <p>Dr. Khalid Waleed Al Ghazawi, CEO of Ebdaa Bank, partook in “Middle East Investment Conference” in Cairo, Egypt where international thought leaders, policymakers and key market participants are gathered to discuss trends shaping the Middle East and North Africa region, as well as its role in the global economy.</p>
                 <p>Dr. Khalid Waleed Al Ghazawi, CEO of Ebdaa Bank, called for greater integration of microfinance industry in the Arab world and to enhance its development which provides funding and training for SMEs in the region, especially in countries such as Egypt, Sudan, Mauritania and Jordan.</p>
                 ...
                 <p>“Although the capital of the SMEs is mainly from donors, our work requires lending to those in need and ensuring the success of their projects and retrieving the loan to grant it to another needy person. This is, of course, different from grants, zakat or charitable giving.” Said CEO of Ebdaa Bank Dr. Al Ghazawi</p>
        ...
        <div class="modal-content">
          <div class="modal-body ">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
				<h4>Ebdaa Bank is an exclusive sponsor of the "N3een N3awen” campaign </h4>
                <hr>
                   <div id="slides_News5" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-item active">
            <img class="d-block w-75" src="assets/img/news/news_6.jpg" alt="First slide">
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
               ...
               <div class="box_shadow" >
                 <p>Ebdaa Bank announced its exclusive sponsorship of the campaign “N3een N3awen” –a social marketing campaign by Public Relations Majors-initiated by a number of students of University of Bahrain (UOB) under the auspices of the president of UOB Dr. Riyadh Hamza. </p>
                 ...
                 <p>Dr. Khalid Waleed Al Ghazawi, CEO of Ebdaa Bank, stressed the bank’s keenness to fulfill its social responsibility towards Bahraini society through encouraging volunteerism and increase community partnership and solidarity among all members of society.</p>
                 <p>CEO of Ebdaa Bank praised such voluntary initiatives of Bahraini youth, which reflect their keenness to develop their society, adopt positive attitudes and develop their lifestyles in a modern manner without abandoning their traditions and values.</p>
        ...
        <div class="modal-content">
          <div class="modal-body ">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
				<h4>Ebdaa Bank - Bahrain Links its New Strategic Plan to SDGs </h4>
                <hr>
          ...
          <div class="carousel-item active">
            <img class="d-block w-75" src="assets/img/news/news_7.jpg" alt="First slide">
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
               ...
               <div class="box_shadow" >
                 <p>Dr. Khalid Al Ghazawi, CEO of Ebdaa Bank - Bahrain said that the bank is currently fully reviewing its new strategy to meet the Sustainable Development Goals (SDGs) to support services of Bahrain’s society and economy.</p>
                 ...
                 <p>CEO of Ebdaa Bank highlighted the eighth goal “Decent Work and Economic Growth”, stressing the keenness of the bank to provide conducive environment to suit employees competencies and aspiration. It also contributes in national economy development through granting loans to microenterprises.</p>
        ...
        <a class="carousel-control-next" href="#slides_News8" role="button" data-slide="next">
          <span class="carousel-control-next-icon" aria-hidden="true"></span>
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
               ...
               <div class="box_shadow" >
                 <p>Dr. Khalid Waleed Al Ghazawi, CEO of Ebdaa Bank, talks to the chairman of Iraq Private Banks League Mr. Waleed Al Handal about Bahrain’s experience in Microfinance represented by Ebdaa Bank.</p>
                 <p>A meeting was held at the headquarters of Ebdaa bank in Bahrain, during which Dr Al Ghazawi discussed Bank’s experience over the past nine years and its success during the last three years which allow the bank to provide a working guide in MFIs. </p>
                 <p>CEO of Ebdaa Bank stressed the keenness of the bank to provide the needed experiences and consultations to back MFIs in Iraq, where its need to overcome economic difficulties and increase their contribution to provide loans for citizens.</p>
                 ...
                 <p>IPBL delegation visited Ebdaa Bank’s branches to be introduced to its experience with loaners’ projects.</p>
               </div>
              </div>
            </div>
          </div>
        ...
        <div class="modal-content">
          <div class="modal-body ">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
				<h4>Ebdaa Bank Nod to Adopt Microfinance in Gulf Charities</h4>
                <hr>
        ...
        <a class="carousel-control-next" href="#slides_News9" role="button" data-slide="next">
          <span class="carousel-control-next-icon" aria-hidden="true"></span>
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
               ...
               <div class="box_shadow" >
                 <p>Ebdaa Bank has agreed with a proposal to microfinance project adopted by charities due to its sustainability to develop their financial resources thus to achieve their objectives to support low-income families. At a time that donations are very less compared to the people needs.</p>
                 <p>CEO of Ebdaa Bank Dr Waleed Al Ghazawi welcomed Almajdouie Group, stressing the need of GCC to adopt microfinance due to its benefit for charity donations.</p>
                 ...
                 <p>Dr Al Ghazawi stressed the keenness of Ebdaa Bank to provide institutions and charities with necessary expertise which would develop their business. The success of Microfinance experience is considered a leading model for charity institutions to develop their business to advanced levels. </p>
                 <p>CEO of Ebdaa Bank said, “Microfinance policy is based on a simple concept referred to a proverb that says “do not feed a fish to hungry, he would ask for more however teach him how to be fisher.” Microfinance is based on exploring actual needs of people to launch their own business through giving advice, consultation, training and follow-up until he can take charge of his project himself.”</p>
        ...
        <div class="modal-content">
          <div class="modal-body ">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
				<h4>Ebdaa Bank celebrates Employee Appreciation</h4>
                <hr>
          ...
          <div class="carousel-item active">
            <img class="d-block w-75" src="assets/img/news/news_10.1.jpg" alt="First slide">
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
               ...
               <div class="box_shadow" >
                 <p>Dr Khalid Waleed Al Ghazawi, CEO of Ebdaa Bank, honored a number of employees who were distinguished for their outstanding performance in recent years as a part of Bank’s staff motivation program to encourage them for an enhanced performance and productivity.</p>
                 ...
                 <p>He pointed that this celebration is to thank Ebdaa Bank’s staff for their distinguished productivity due to achieve further upgraded work relying on Bank’s human capital.</p>
