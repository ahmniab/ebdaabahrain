...
<head>
  ...
  <link rel="stylesheet" href="css/min/home.css">
...
<body>
  ...
  <div class="owl-container lazy-bg" data-bg="assets/img/testimonial-bg.jpg">
    <div class="container-theme">
      <div class="owl-carousel owl-theme">
        <div class="item">
          <div class="item-img-container">
            <img src="assets/img/team/clainets-01.png" loading="lazy" alt="laila image">
          </div>
          <p class="item-text">
        ...
        <div class="item">
          <div class="item-img-container">
            <img src="assets/img/team/clainets-03.png" loading="lazy" alt="noora image">
          </div>
          <p class="item-text">
            <i class="fa <?php echo $lang == 'ar' ? 'fa-quote-right': 'fa-quote-left';?>"></i>
        ...
        <div class="item">
          <div class="item-img-container">
            <img src="assets/img/team/clainets-06.png" loading="lazy" alt="yasser image">
          </div>
          <p class="item-text">
            <i class="fa <?php echo $lang == 'ar' ? 'fa-quote-right': 'fa-quote-left';?>"></i>
        ...
        <div class="item">
          <div class="item-img-container">
            <img src="assets/img/team/clainets-08.png" loading="lazy" alt="truky image">
          </div>
          <p class="item-text">
            <i class="fa <?php echo $lang == 'ar' ? 'fa-quote-right': 'fa-quote-left';?>"></i>
        ...
        <div class="item">
          <div class="item-img-container">
            <img src="assets/img/team/clainets-07.png" loading="lazy" alt="lailaa">
          </div>
          <p class="item-text">
            <i class="fa <?php echo $lang == 'ar' ? 'fa-quote-right': 'fa-quote-left';?>"></i>
              ...
              <div class="row contact-boxes-container">
                ...
                <div class="col-lg-6 col-lg-6">
                  <div class="contact-box container-fluid--mobile">
                    ...
                    <hr />
                    <ul>
                      <li><a href="tel:+973 17381000"><i class="fa fa-phone"></i><span dir="ltr">+973 17381000</span></a></li>
                ...
                <div class="col-lg-6 col-lg-6">
                  <div class="contact-box container-fluid--mobile">
                    ...
                    <hr />
                    <ul>
                      <li><a href="tel:+973 17381003"><i class="fa fa-phone"></i><span dir="ltr">+973 17381003</span></a></li>
                ...
                <div class="col-lg-6 col-lg-6">
                  <div class="contact-box container-fluid--mobile">
                    ...
                    <hr />
                    <ul>
                      <li><a href="tel:+973 17381018"><i class="fa fa-phone"></i><span dir="ltr">+973 17381018</span></a></li>
