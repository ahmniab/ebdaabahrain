 <section id="services" class="section">
      <div class="container">
        <div class="section-header">
          <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">قروض الإبداع</h2>
          ...
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="col-sm-12 col-md-12 col-lg-6">
                <h4>قرض الامل </h4>
 			          <hr>
                <p>الان بنك الإبداع يقدم قرض الامل المخصص لدعم المشاريع التجارية والخدماتية والصناعية بشروط ميسرة.</p>
