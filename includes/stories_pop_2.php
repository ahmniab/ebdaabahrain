          ...
          <div class="carousel-item active">
            <img class="d-block w-75" src="assets/img/story/story_2.jpg" alt="First slide">
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
			   ...
			   <p>To develop her business further, Sahira borrowed BD 600 from Ebdaa Bank to purchase necessary equipment for cooking. In doing so, she was able to practice her passion further and reach more of her clients. </p>
			   </div>
              </div>
            </div>
          </div>
        ...
        <a class="carousel-control-next" href="#slides_story_4" role="button" data-slide="next">
          <span class="carousel-control-next-icon" aria-hidden="true"></span>
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
			   ...
			   <p>In 2016, Mohammed’s business came to life when he began selling shoes and bags in the commercial markets. Mohammed knew that in order for a business to grow there needed to be expansions -- which could only be possible with a steady cash flow. Thus, he obtained three loans from Ebdaa Bank at different time intervals ranging between 300 dinars and 600 dinars. </p>
			   <p>These loans allowed him to keep his business evolving and expanding. Also, Mohammed's commitment to repaying his loans on time have greatly increased his credibility with the Bank. His relationship transformed from being just a client to now a continuously evolving and successful partnership. </p>
			    </div>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item active">
            <img class="d-block w-75" src="assets/img/story/story_6.JPG" alt="First slide">
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
			   ...
			   <p>Ahmad business has proven its success, and now he is seeking to develop this project from various aspects, while Ebdaa Bank is always ready to support its outstanding customers.</p>
			   </div>
              </div>
            </div>
          </div>
...
<div class="modal fade " id="story_7" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <a class="carousel-control-next" href="#slides_story_7" role="button" data-slide="next">
     ...
     <p>He was able to finance this expansion by obtaining loans from Ebdaa Bank. He received a loan in the amount of BD 2000 -- which he is now paying back in convenient installments and with full commitment. </p>
...
<div class="modal-dialog" role="document">
  ...
  <a class="carousel-control-next" href="#slides_story_9" role="button" data-slide="next">
   ...
   <p>Hameed Hassan Ali Eid is a client at Ebdaa Bank who breeds birds for a living -- hatching and selling them. This was a hobby that Hameed realized doesn’t only have to be fun, but can also be profitable. Working with pets is a wonderful profession, and Hassan is an example of a person who was able to turn their hobby into a job. He was aware that he needed some extra money in order to expand his business to buy more birds. That’s when he applied for a loan at Ebdaa Bank, and with the necessary funding, was able to achieve his dream job. </p>
    ...
    <div class="carousel-item active">
      <img class="d-block w-75" src="assets/img/story/story_10.jpg" alt="First slide">
        ...
        <div class="col-sm-12 col-md-12 col-lg-12">
         ...
         <div class="box_shadow" >
   <p>Hamad Abbas Shabib lives in AAli and owns a farm to rent horses and livestock in the area of Karana. Within the field of horses, he specifically trains children on horse back riding and provides them with necessary and basic instructions.</p>
   <p>Recently, Hassan wanted to expand his business by adding a new experience -- raising sheep. He reached out to Ebdaa Bank and is now grateful for our support in helping to enable his business expand. </p>
