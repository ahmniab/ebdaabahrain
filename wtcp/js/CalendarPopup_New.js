...
if (window.location.href.indexOf("spiralsolutions")>-1) 
{ 
	alert("Please stop linking directly to the JS file on mattkruse.com! Please copy the JS files to your server instead!"); 
	window.location.href="http://www.mattkruse.com/"; 
}
