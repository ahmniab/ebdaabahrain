    ...
    <tr>
      ...
      <td bgcolor="#666666"><table width="600" border="0" cellpadding="2">
          ...
          <tr align="right">
            ...
            <td valign="top" bgcolor="#CCCCCC"><strong>التفاصيل</strong></td>
          </tr>
...
<?php echo $getact ; ?>
          ...
          <tr align="right">
            ...
            <td bgcolor="#CCCCCC"><select name='catid' class="smalltext" dir="rtl" >
                ...
                <option value='novalue'>حدد قسما</option>
...
?>
            ...
            <td bgcolor="#CCCCCC"><strong>القسم</strong></td>
          </tr>
...
?>
          ...
          <tr align="right">
            ...
            <td bgcolor="#CCCCCC"><input name="e_year" type="hidden" id="e_year" value="0">
...
<tr align='center'>
  ...
  <td height='20' valign='middle'><a href='{$_SERVER['PHP_SELF']}?action=edit&imageid=$imageid'>تعديل</a></td>

  </tr>

<tr align='center'>

  <td height='25' valign='middle'><a href='{$_SERVER['PHP_SELF']}?action=delcon&imageid=$imageid'>حذف</a></td>
...
<table width="955" border="0" cellspacing="2" cellpadding="2">
  <tr>
    ...
    <td colspan="2" align="right"><select name="active" id="active" onChange="MM_jumpMenu('self',this,0)" dir="rtl">
      <option value="?<?php echo "{$CAT_U}{$USERID_U}{$BUY_TYPE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}"?>">الكل</option>
      <?php
if (isset($_GET['active']) && $_GET['active']=='0') {
echo "
<option value='?{$CAT_U}{$USERID_U}{$BUY_TYPE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}active=0' selected>غير مفعل</option>
<option value='?{$CAT_U}{$USERID_U}{$BUY_TYPE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}active=1'>مفعل</option>
";

} elseif (isset($_GET['active']) && $_GET['active']=='1') {
echo "
<option value='?{$CAT_U}{$USERID_U}{$BUY_TYPE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}active=0'>غير مفعل</option>
<option value='?{$CAT_U}{$USERID_U}{$BUY_TYPE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}active=1' selected>مفعل</option>
";
} else {
echo "
<option value='?{$CAT_U}{$USERID_U}{$BUY_TYPE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}active=0'>غير مفعل</option>
...
?>
    ...
    <td align="right" bgcolor="#eeeeee">القسم</td>
  </tr>
  ...
  <tr>
    <td colspan="4" align="right"><input name="Clear All" type="button" id="Clear All" onClick="selectAllCheckBoxes('update_active', 'checkbox[]', false);" value="عدم تحديد الكل">
    ...
    <td width="64" align="right" bgcolor="#eeeeee">التحديد</td>
  </tr>
  <tr>
    <td width="539" align="right">&nbsp;&nbsp;</td>
    <td width="80" align="right" bgcolor="#66CC66"><input name="update" type="submit" id="update" value="تحديث البيانات"></td>
    <td width="74" align="right" bgcolor="#ff0000"><input name="delete" type="submit" id="delete" value="حذف البيانات" onClick="return delete_confirm()"></td>
    <td width="166" align="right">&nbsp;&nbsp;
        <input name="active" type="submit" id="active" value="التفعيل">
      &nbsp;&nbsp;
      <input name="notactive" type="submit" id="notactive" value="ازالة التفعيل"></td>
...
?>
    ...
    <td colspan="2" align="right"><select name="catid" id="catid" onChange="MM_jumpMenu('self',this,0)" dir="rtl">
        <option value="?<?php echo "{$BUY_TYPE_U}{$USERID_U}{$ACTIVE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}"?>">كل الأقسام</option>
        <?php
if (isset($_GET['catid']) && $_GET['catid']!='') {$SELECTED_CAT_ID= intval($_GET['catid']);} else { $SELECTED_CAT_ID= "0";}
  ...
  <tr>
    <td align="right"><span class="box">
      <select name="userid" id="userid"  dir="rtl" onChange="MM_jumpMenu('self',this,0)">
        <option value="?<?php echo "{$CAT_U}{$USERID_U}{$ACTIVE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}"?>">الكل</option>
        <?php
///// reg
...
?>
    ...
    <td align="right" bgcolor="#EEEEEE">معروضات العضو</td>
...
echo "
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}buy_type=0' selected>المنتجات</option>
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}buy_type=1'>الطلبات</option>
";

} elseif (isset($_GET['buy_type']) && $_GET['buy_type']=='1') {
echo "
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}buy_type=0'>المنتجات</option>
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}buy_type=1' selected>الطلبات</option>
";
} else {
echo "
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}buy_type=0'>المنتجات</option>
...
?>
    ...
    <td align="right" bgcolor="#eeeeee">النوع</td>
  </tr>
  <tr>
    <td align="right"><span class="box">
      <select name="sale_type" id="sale_type"  dir="rtl" onChange="MM_jumpMenu('self',this,0)">
        <option value="?<?php echo "{$CAT_U}{$USERID_U}{$ACTIVE_U}{$ITEM_STATUS_U}{$BUY_TYPE_U}"?>">الكل</option>
        <?php
if (isset($_GET['sale_type']) && $_GET['sale_type']=='0') {
echo "
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$ITEM_STATUS_U}{$BUY_TYPE_U}sale_type=0' selected>سعر ثابت</option>
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$ITEM_STATUS_U}{$BUY_TYPE_U}sale_type=1'>قبل للتفاوض</option>
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$ITEM_STATUS_U}{$BUY_TYPE_U}sale_type=2'>مزاد</option>
";

} elseif (isset($_GET['sale_type']) && $_GET['sale_type']=='1') {
echo "
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}{$BUY_TYPE_U}sale_type=0'>سعر ثابت</option>
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}{$BUY_TYPE_U}sale_type=1' selected>قبل للتفاوض</option>
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}{$BUY_TYPE_U}sale_type=2'>مزاد</option>
";

} elseif (isset($_GET['sale_type']) && $_GET['sale_type']=='2') {
echo "
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}{$BUY_TYPE_U}sale_type=0'>سعر ثابت</option>
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}{$BUY_TYPE_U}sale_type=1'>قبل للتفاوض</option>
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}{$BUY_TYPE_U}sale_type=2' selected>مزاد</option>
";
} else {
echo "
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$ITEM_STATUS_U}{$SALE_TYPE_U}{$BUY_TYPE_U}sale_type=0'>سعر ثابت</option>
...
?>
    ...
    <td align="right" bgcolor="#EEEEEE">المنتج للـ</td>
    <td colspan="2" align="right"><select name="item_status" id="item_status" onChange="MM_jumpMenu('self',this,0)" dir="rtl">
        <option value="?<?php echo "{$CAT_U}{$USERID_U}{$ACTIVE_U}{$BUY_TYPE_U}{$SALE_TYPE_U}"?>">الكل</option>
        <?php
if (isset($_GET['item_status']) && $_GET['item_status']=='0') {
echo "
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$BUY_TYPE_U}{$SALE_TYPE_U}item_status=0' selected>غير محدد</option>
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$BUY_TYPE_U}{$SALE_TYPE_U}item_status=1'>مستعمل</option>
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$BUY_TYPE_U}{$SALE_TYPE_U}item_status=2'>جديد</option>
";

} elseif (isset($_GET['item_status']) && $_GET['item_status']=='1') {
echo "
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$BUY_TYPE_U}{$SALE_TYPE_U}item_status=0'>غير محدد</option>
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$BUY_TYPE_U}{$SALE_TYPE_U}item_status=1' selected>مستعمل</option>
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$BUY_TYPE_U}{$SALE_TYPE_U}item_status=2'>جديد</option>
";
...
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$BUY_TYPE_U}{$SALE_TYPE_U}item_status=0'>غير محدد</option>
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$BUY_TYPE_U}{$SALE_TYPE_U}item_status=1'>مستعمل</option>
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$BUY_TYPE_U}{$SALE_TYPE_U}item_status=2' selected>جديد</option>
";
} else {
echo "
<option value='?{$CAT_U}{$USERID_U}{$ACTIVE_U}{$BUY_TYPE_U}{$SALE_TYPE_U}item_status=0'>غير محدد</option>
...
?>
    ...
    <td align="right" bgcolor="#eeeeee">حالة المنتج</td>
  </tr>
  <tr>
    <td colspan="5" align="right">&nbsp;</td>
    </tr>
...
$view_all = mysql_query("SELECT * FROM images WHERE imageid!='0' $CAT_Q $ACTIVE_Q $USERID_Q $BUY_TYPE_Q ORDER BY imageid ASC LIMIT $from, $max_results") or die (mysql_error()); 
...
<tr align='center'>
  <td width='37%' rowspan='5'><a href='$image_info' target='_blank'><img src='$thumbnail_info' border='1'></a></td>
  <td height='20' align='left' valign='middle'>صور اضافية</td>
  <td align='left' valign='middle' dir='rtl'><a href='images_extra.php?action=add&catid=$catid&image_id=$imageid'>اضف</a> - <a href='images_extra.php?image_id=$imageid'>شاهد ($extra)</a></td>
</tr>
<tr align='center'>

  <td width='26%' height='20' align='left' valign='middle'><a href='?action=edit&imageid=$imageid'>تعديل</a></td>
  <td width='37%' align='left' valign='middle'><a href='?action=delcon&imageid=$imageid'>حذف</a></td>
</tr>

<tr align='center'>
  <td height='25' colspan='2' align='left' valign='middle'>BD. 
    <input name='price_{$imageid}' type='text' id='price_{$imageid}' value='$price' size='15' maxlength='255'></td>
</tr>
<tr align='center'>
