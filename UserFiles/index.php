...
.job2 {border-radius: 6px;}
  ...
  <body class="ar-font">
      ...
      <nav class="navbar navbar-expand-lg fixed-top scrolling-navbar indigo">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="main-navbar" >
            <ul class="navbar-nav  w-75 justify-content ar-dir">
              ...
              <li class="nav-item"><a class="nav-link page-scroll" href="#application">طلب قرض</a></li>
	   ...
	   <!--   <li class="nav-item"><a class="nav-link page-scroll" href="Ebdaamail.php">تأجيل القسط</a></li>-->
        ...
        <ul class="mobile-menu">
          ...
          <li><a class="page-scroll" href="#application">طلب قرض</a></li>
		...
		<div class="navbar-header">
              <a href="index.php" class="navbar-brand"><img id="logo" class="img-fulid" src="assets/img/logo_arabic_white.png" alt=""></a>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">تمويل المشاريع الصغيرة ومتناهية الصغر</h1>
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">تمويل يصل الى 7000 دينار </p>
              <a href="#application" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">تقدم بطلبك الان</a>
            </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="carousel-caption d-none d-md-block">
			  ...
			  <a href="#portfolios" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">قصص النجاح</a>
            </div>
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="assets/img/slide/slide3.jpg" alt="Third slide">
            <div class="carousel-caption d-none d-md-block">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">استفد من منتجات أبداع البحرين لبدء وتطوير مشروعك</h1>
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms"> عليك الفكرة ...وعلينا التمويل  </p>
              <a href="#services" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">تعرف على منتجاتنا</a>
            </div>
          </div>
		  <div class="carousel-item">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-3 col-lg-3 hoverable">
            <div class="facts-item normal">
              ...
              <div class="fact-count">
                <h3><span class="counter">16,490</span></h3>
                <h4>عميل</h4>
              </div>
            </div>
			<div class="facts-item hover ">
              ...
              <div class="fact-count">
                <h3><span class="counter">8,761</span></h3>
                <h4>رجال </h4>
              </div>
			   <div class="icon">
              ...
              <div class="fact-count">
                <h3><span class="counter">7,719</span></h3>
                <h4>نساء</h4>
              </div>
            </div>
          </div>
		  <div class="col-sm-6 col-md-3 col-lg-3 hoverable">
			...
			<div class="facts-item hover ">
              ...
              <div class="fact-count">
                <h3><span class="counter"> 2,835</span></h3>
                <h4>القائمة  </h4>
              </div>
			   <div class="icon">
              ...
              <div class="fact-count">
                <h3><span class="counter">13,655</span></h3>
                <h4>المسددة</h4>
              </div>
            </div>
          </div>
		  <div class="col-sm-6 col-md-3 col-lg-3 hoverable">
            <div class="facts-item normal">
              ...
              <div class="fact-count">
                <h3><span class="counter">19,545,840</span></h3>
			...
			<div class="facts-item hover ">
              ...
              <div class="fact-count">
                <h3><span class="counter">2,652,307</span></h3>
                <h4>القائمة </h4>
              </div>
			   <div class="icon">
                <i class="fa fa-folder"></i>
              ...
              <div class="fact-count">
                <h3><span class="counter"> 16,913,533</span></h3>
                <h4>المسددة</h4>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
            <div class="facts-item">
			  ...
			  <!-- end of counter -->
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">أبداع البحرين ... خطوة بخطوة معك  </p>
              <a href="#contact" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">تفضل بزيارتنا</a>
            </div>
          </div>
		  <div class="carousel-item">
            <img class="d-block w-100" src="assets/img/slide/slide5.jpg" alt="Fifth slide">
            <div class="carousel-caption d-none d-md-block">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s"> فريق عمل أبداع البحرين </h1>
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">خدمتكم  شرف  ... ورضاكم هدفنا   </p>
              <a href="#team" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">فريق العمل </a>
            </div>
          </div>
		  <div class="carousel-item">
            <img class="d-block w-100" src="assets/img/slide/slide6.jpg" alt="sixth slide">
            <div class="carousel-caption d-none d-md-block">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s"> تعاون مشترك بين أبداع البحرين ومكتب الأمم المتحدة لدعم التنمية المستدامة</h1>
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">لتفاصيل الخبر  </p>
              <a href="#blog" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">اخبارنا</a>
            </div>
          </div>
        </div>
    ...
    <!-- About Us Section Start -->
      ...
      <div class="container">
        <div class="section-header">
          <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">من نحن </h2>
          <hr class="lines wow zoomIn" data-wow-delay="0.3s">
          <p class="section-subtitle wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">ندعم مشاريع التمويل الأصغر بفلسفة تمكين وتنمية مهارات الفئات الأقل حظاً، وخصوصاً النساء، لتحسين ظروف حياتهن </p>
        </div>
        <div class="row" style="width: 100%;">
            ...
            <!--start of tab 1-->
    			  <div id="tabs-1" class="ar-txt">
              <h2> عن أبداع البحرين </h2>
  			      <hr>
          			...
          			<div class="col-lg-5 col-md-5 col-sm-10 col-xs-6 box_shadow" >
          			  ...
          			  <p>خدمات اقراضية ميسرة تدعم جهود توسعة الطبقة المتوسطة في مملكة البحرين.</p>
      					...
      					<div class="col-lg-11 col-md-11 col-sm-10 col-xs-6 box_shadow" >
      					  ...
      					  <hr>
                        <p>تأسس أبداع البحرين للتمويل متناهي الصغر في الحادي عشر من فبراير 2009 كأول بنك متخصص في التمويل الاصغر في مملكة البحرين وذلك برعاية ومباركة كريمة من صاحبة السمو الملكي الاميرة سبيكة بنت ابراهيم آل خليفة قرينة ملك مملكة البحرين رئيسة المجلس الأعلى للمرأة حفظها الله , و المغفور له "بإذن الله" الأمير طلال بن عبد العزيز آل سعود رئيس برنامج الخليج العربي للتنمية "أجند"، وذلك إيمانا من الجميع بدور هذه البنوك في دعم محدودي الدخل، ومساهمتها في إطلاق إبداعاتهم وتحقيق طموحاتهم عن طريق توفير القروض الصغيرة بشروط سهله ومسيرة.</p>      			
						<p>عمل أبداع البحرين منذ تأسيسه على تقديم كافة سبل الدعم لذوي الدخل المحدود وأصحاب المشاريع الصغيرة سعياً من البنك لزيادة دخل المواطنين وتحسين مستوى معيشتهم وذلك بتحويل المواهب والحرف التي يمتلكونها الى مشاريع ناجحة من خلال توفير القروض متناهية الصغر والصغيرة، مع التركيز على المرأة والشباب، إضافة إلى إدارة البنك للمحفظة المالية لصاحبة السمو الملكي الاميرة سبيكة بنت ابراهيم آل خليفة لدعم المرأة وتمكينها اقتصاديا بالتعاون مع المجلس الأعلى للمرأة وصندوق العمل "تمكين".</p>      						
	                    <p>يقدم أبداع البحرين التمويل بصيغته الإسلامية والتقليدية على حد سواء، وقد حصل البنك على جائزة "أفضل تمكين للمرأة على مستوى دول مجلس التعاون الخليجي" من قبل حكومة دبي، في مايو 2017 تقديراً لدوره في دعم المرأة البحرينية وتمكينها اقتصاديا. </p>						</div>
  					    <div class="col-lg-11 col-md-11 col-sm-10 col-xs-6 box_shadow" >
  			          <h1>اهدافنا</h1>
  			          <hr>
          				<p>
          ...
          <div class="row ar-dir" style="margin: 20px;">
              ...
              <div class="single-team">
                ...
                <div class="team-details">
                  <div class="team-inner">
                    <a href="#" data-toggle="modal" data-target="#Mona"><h4 class="team-title">السيدة منى يوسف المؤيد</h4>
                    <p>رئيسة مجلس الإدارة</p></a>
                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#Mona" style="color:#61D2B4">السيرة الذاتية </a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-xs-12"style="padding-bottom: 20px;">
              <div class="single-team">
                ...
                <div class="team-details">
                  <div class="team-inner">
                    <a href="#" data-toggle="modal" data-target="#Naser"><h4 class="team-title">السيد ناصر بكر القحطاني</h4>
                    <p>نائب رئيس مجلس الإدارة</p></a>
  					        <a href="#" class="btn btn-link" data-toggle="modal" data-target="#Naser" style="color:#61D2B4">السيرة الذاتية </a>
                  </div>
                </div>
              </div>
            </div>
			<div class="col-lg-4 col-md-6 col-xs-12"style="padding-bottom: 20px;">
              <div class="single-team">
                ...
                <div class="team-details">
                  <div class="team-inner">
                    <a href="#" data-toggle="modal" data-target="#Samar"><h4 class="team-title">	 السيدة سمر ويصا عجايبي</h4>
                    <p>عضو مجلس إدارة </p></a>
  					        <a href="#" class="btn btn-link" data-toggle="modal" data-target="#Samar" style="color:#61D2B4">السيرة الذاتية</a>
                  </div>
                </div>
              </div>
            </div>
			<div class="col-lg-4 col-md-6 col-xs-12"style="padding-bottom: 20px;">
              <div class="single-team">
                <a href="#" data-toggle="modal" data-target="#Sanjeev"><img class="img-fulid" src="assets/img/board/Sanjeev.jpg" alt=""></a>
                <div class="team-details">
                  <div class="team-inner">
                   <a href="#" data-toggle="modal" data-target="#Sanjeev"> <h4 class="team-title">	السيد سانجيف بول</h4>
                    <p>عضو مجلس ادارة </p></a>
  					        <a href="#" class="btn btn-link" data-toggle="modal" data-target="#Sanjeev" style="color:#61D2B4">السيرة الذاتية</a>
                  </div>
                </div>
              </div>
            </div>
			<div class="col-lg-4 col-md-6 col-xs-12"style="padding-bottom: 20px;">
              <div class="single-team">
                ...
                <div class="team-details">
                  <div class="team-inner">
                    <a href="#" data-toggle="modal" data-target="#Abed"><h4 class="team-title">السيد عبد الحميد ديواني </h4>
                    <p>عضو مجلس إدارة</p></a>
  					        <a href="#" class="btn btn-link" data-toggle="modal" data-target="#Abed" style="color:#61D2B4">السيرة الذاتية</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-xs-12"style="padding-bottom: 20px;">
              <div class="single-team">
                <a href="#" data-toggle="modal" data-target="#Adel"><img class="img-fulid" src="assets/img/board/Adel.jpg" alt=""></a>
                <div class="team-details">
                  <div class="team-inner">
                   <a href="#" data-toggle="modal" data-target="#Adel"> <h4 class="team-title">السيد عادل محمد بله</h4>
                    <p>عضو مجلس إدارة </p></a>
  					        <a href="#" class="btn btn-link" data-toggle="modal" data-target="#Adel" style="color:#61D2B4">السيرة الذاتية </a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="single-team">
                ...
                <div class="team-details">
                  <div class="team-inner">
                    <a href="#" data-toggle="modal" data-target="#Bader"><h4 class="team-title">	د. بدر الدين عبدالرحيم</h4>
                    <p>عضو مجلس إدارة </p></a>
  					        <a href="#" class="btn btn-link" data-toggle="modal" data-target="#Bader" style="color:#61D2B4">السيرة الذاتية</a>
                  </div>
                </div>
              </div>
            </div>
		...
		<!-- board popup start -->
		<div class="modal fade ar-dir" id="Mona" tabindex="-1" role="dialog" aria-hidden="true">
	...
	<div class="modal fade ar-dir" id="Naser" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
	...
	<div class="modal fade ar-dir" id="Adel" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
...
إضافة إلى ذلك يشغل السيد بله منصب المدير العام لبنك الإبداع للتمويل متناهي الصغر في السودان، وعضو مجالس إدارة بنوك وشركات الإبداع للتمويل متناهي الصغر في موريتانيا، الأردن, سوريا, ولبنان. ويمتلك السيد بله خبرة طويلة في التمويل متناهي الصغر حيث تقلد العديد من المناصب في المؤسسات المختصة بالتمويل الاصغر في السودان، ويحمل السيد عادل درجة البكالوريوس في المحاسبة التجارية منذ عام 1987 من جامعة الخرطوم.
	...
	<div class="modal fade ar-dir" id="Abed" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
...
وهو يشغل كذلك عضوية العديد من مجالس إدارات شركات بحرينية، كما أنه عضو تنفيذي في مجموعة شركات الجزيرة وعضو في مصنع المنامة للأغذية، ويحمل السيد دواني درجة جامعية في الهندسة المدنية من جامعة الاسكندرية.
	...
	<div class="modal fade ar-dir" id="Samar" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
	...
	<div class="modal fade ar-dir" id="Bader" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
	...
	<div class="modal fade ar-dir" id="Sanjeev" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6">
                  <img src="assets/img/board/Sanjeev.jpg" alt="" style="width:100%;">
                </div>
              <div class="col-sm-12 col-md-12 col-lg-6">
                <h4>السيد سانجيف بول</h4>
                <hr>
               <div class="box_shadow" >
			   <p>السيد سانجيف بول هو الرئيس التنفيذي لبنك البحرين للتنمية منذ مايو 2018، وهو بنك متخصص في تمويل وتطوير الأعمال الصغيرة والمتوسطة إضافة إلى تشجيع ودعم ريادة الأعمال في مملكة البحرين، ويتبنى بنك البحرين التنمية استراتيجية ديناميكية وفعالة لتحفيز النشاط الريادي في تنفيذ خططه لتمويل وتمويل الشركات الصغيرة والمتوسطة.</p>
			   <p>يعمل السيد سانجيف بول أيضًا كرئيس مجلس الإدارة والمدير غير التنفيذي في مجلس إدارة بنك ستاندرد تشارترد بنك فيتنام منذ يونيو 2016.</p>
			   <p>يتمتع السيد سانجيف بول بخبرة تمتد لأكثر من 30 عامًا كمصرفي بارز في بنك ستاندرد تشارترد، وكان عضوًا في فريق القيادة العالمي لنفس البنك  ومقره سنغافورة، وشغل منصب المدير الإداري والرئيس الإقليمي للخدمات المصرفية التجارية لرابطة دول جنوب شرق آسيا (آسيان) وجنوب آسيا، وقبل ذلك قاد قطاع الشركات المحلية التابع لبنك ستاندرد تشارترد على الصعيد العالمي كرئيس عالمي لها، حيث تمتد الأعمال التجارية المحلية لبنك ستاندرد تشارترد الى أكثر من 30 دولة بما في ذلك البحرين وتضم معظم عملاء مجموعة ستاندرد تشارترد.</p>
			   <p>السيد بول حاصل على درجة البكالوريوس في الهندسة من كلية دلهي للهندسة ودرجة الماجستير في العلوم المالية والتسويق من جامعة دلهي في الهند. ويشغل السيد بول منصب عضو في لجنة الحوكمة التابعة لمجلس الإدارة .</p>
               </div>
              </div>
            </div>
          </div>
        ...
        <!-- end of tab 3 -->
        <!--start of tab 4-->
		    <div id="tabs-4" class="ar-txt">
		      <div class="container" >
		    <h2> القوائم المالية المدققه الى أبداع البحرين</h2>	
			<hr>
            <ul class="timeline">
			<li>
			...
			<li>
              ...
              <li>
                ...
                <div class="timeline-panel">
                    ...
                    <div class="timeline-body">
		                      <p>البيانات المالية التابعة الى ابداع البحرين للسنة المنتهية في 31 ديسمبر2017</p>	
							  </div>
        			    </a>
        		    </div>
              </li>
              <li>
                ...
                <div class="timeline-panel">
                  <a href="assets/fainancial _report/FS2016 Al Ebdaa Bank.pdf" target="_blank"  >
                    ...
                    <div class="timeline-body">
                    <p>البيانات المالية التابعة الى ابداع البحرين للسنة المنتهية في 31 ديسمبر2016</p>
                    </div>
        			    </a>
                  </div>
                </li>
                <li  class="timeline-inverted">
                  ...
                  <div class="timeline-panel">
                      ...
                      <div class="timeline-body">
				       <p>البيانات المالية التابعة الى ابداع البحرين للسنة المنتهية في 31 ديسمبر2015</p>  
					   </div>
        			   </a>
                  </div>
                </li>
                <li>
                  ...
                  <div class="timeline-panel">
                      ...
                      <div class="timeline-body">
		                <p>البيانات المالية التابعة الى ابداع البحرين للسنة المنتهية في 31 ديسمبر2014 </p>	
						</div>
              			</a>
                  </div>
                </li>
                <li  class="timeline-inverted">
                  ...
                  <div class="timeline-panel">
                    <a href="assets/fainancial _report/fs2013.pdf" target="_blank"  >
                      ...
                      <div class="timeline-body">
				      	<p>البيانات المالية التابعة الى ابداع البحرين للسنة المنتهية في 31 ديسمبر2013 </p>	
					    </div>
        			    </a>
                  </div>
                </li>
                <li>
                  ...
                  <div class="timeline-panel">
                      ...
                      <div class="timeline-body">
				          <p>البيانات المالية التابعة الى ابداع البحرين للسنة المنتهية في 31 ديسمبر2012 </p>
	                      </div>
        			      </a>
                  </div>
                </li>
                <li  class="timeline-inverted">
                  ...
                  <div class="timeline-panel">
                      ...
                      <div class="timeline-body">
				          <p>البيانات المالية التابعة الى ابداع البحرين للسنة المنتهية في 31 ديسمبر2011 </p>	
						  </div>
        			      </a>
                  </div>
                </li>
                <li>
                  ...
                  <div class="timeline-panel">
                      ...
                      <div class="timeline-body">
				          <p>البيانات المالية التابعة الى ابداع البحرين للسنة المنتهية في 31 ديسمبر2010 </p>	
						  </div>
        			      </a>
                  </div>
                </li>
    ...
    <section class="video-promo section" id="Ebdaa_video">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8">
              <div class="video-promo-content text-center">
	                <h2 class="wow zoomIn" data-wow-duration="1000ms" data-wow-delay="100ms"> تعرف على أبداع البحرين من خلال هذا الفيديو القصير</h2>
					<p class="wow zoomIn" data-wow-duration="1000ms" data-wow-delay="100ms ar-dir">تأسس أبداع البحرين للتمويل متناهي الصغر في الحادي عشر من فبراير 2009 كأول بنك متخصص في التمويل الاصغر في مملكة البحرين وذلك برعاية ومباركة كريمة من صاحبة السمو الملكي الاميرة سبيكة بنت ابراهيم آل خليفة قرينة ملك مملكة البحرين رئيسة المجلس الأعلى للمرأة حفظها الله والمغفور له صاحب السمو الملكي الأمير طلال بن عبد العزيز آل سعود رئيس برنامج الخليج العربي للتنمية. </p>
		...
		<div class="modal fade ar-dir" id="Bank_Video" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-body ar-txt">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
                ...
                <div class="row">
				 ...
				 <iframe width="100%" height="600px" src="https://www.youtube.com/embed/1f3FN-PKTYg" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                  </div>
              </div>
            </div>
          </div>
...
<!--	<div class="modal fade ar-dir" id="Bank_Video1" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <section id="services" class="section">
      <div class="container">
        <div class="section-header">
          <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">خدمات الإبداع</h2>
          <hr class="lines wow zoomIn" data-wow-delay="0.3s">
          <p class="section-subtitle wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s ar-dir">.قروضنا صممت لتلائم إحتياجات مشاريعكم
        ...
        <div class="row ar-dir">
          <div class="col-md-6 col-sm-6">
            <div  class="item-boxes wow fadeInDown animated" data-wow-delay="0.2s" style="visibility: visible;-webkit-animation-delay: 0.2s; -moz-animation-delay: 0.2s; animation-delay: 0.2s;">
              ...
              <a href="#" class="btn btn-link" data-toggle="modal" data-target="#sayedaty" style="color:#61D2B4"> التفاصيل و الشروط  </a>
            </div>
          </div>
          <div class="col-md-6 col-sm-6">
            <div class="item-boxes wow fadeInDown animated" data-wow-delay="0.8s" style="visibility: visible;-webkit-animation-delay: 0.8s; -moz-animation-delay: 0.8s; animation-delay: 0.8s;">
              ...
              <a href="#" class="btn btn-link" data-toggle="modal" data-target="#ebdaaLoan" style="color:#61D2B4"> التفاصيل و الشروط  </a>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="item-boxes wow fadeInDown animated" data-wow-delay="1.2s" style="visibility: visible;-webkit-animation-delay: 1.2s; -moz-animation-delay: 1.2s; animation-delay: 1.2s;">
              ...
              <a href="#" class="btn btn-link" data-toggle="modal" data-target="#hopeLoan" style="color:#61D2B4"> التفاصيل و الشروط  </a>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="item-boxes wow fadeInDown animated" data-wow-delay="1.6s" style="visibility: visible;-webkit-animation-delay: 1.2s; -moz-animation-delay: 1.2s; animation-delay: 1.6s;">
              ...
              <a href="#" class="btn btn-link" data-toggle="modal" data-target="#exellenceLoan" style="color:#61D2B4"> التفاصيل و الشروط  </a>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="item-boxes wow fadeInDown animated" data-wow-delay="2s" style="visibility: visible;-webkit-animation-delay: 1.2s; -moz-animation-delay: 1.2s; animation-delay: 2s;">
              ...
              <a href="#" class="btn btn-link" data-toggle="modal" data-target="#seasonalLoan" style="color:#61D2B4"> التفاصيل و الشروط  </a>
            </div>
          </div>
		  <div class="col-md-6 col-sm-6">
            <div class="item-boxes wow fadeInDown animated" data-wow-delay="2.4s" style="visibility: visible;-webkit-animation-delay: 1.2s; -moz-animation-delay: 1.2s; animation-delay: 2s;">
              ...
              <a href="#" class="btn btn-link" data-toggle="modal" data-target="#TafawoqLoan" style="color:#61D2B4"> التفاصيل و الشروط  </a>
            </div>
          </div>
		  ...
		  <div class="col-md-6 col-sm-6">
            <div class="item-boxes wow fadeInDown animated" data-wow-delay="2.8s" style="visibility: visible;-webkit-animation-delay: 1.2s; -moz-animation-delay: 1.2s; animation-delay: 2s;">
              ...
              <a href="#" class="btn btn-link" data-toggle="modal" data-target="#NajahLoan" style="color:#61D2B4"> التفاصيل و الشروط  </a>
            </div>
          </div>
        </div>
      </div>
...
<!-- Services 1 -->
    <div class="modal fade ar-dir" id="sayedaty" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6">
                  <img  src="assets/img/loan/syedaty.jpg" style="width:100%;">
                </div>
              <div class="col-sm-12 col-md-12 col-lg-6">
                <h4>قرض سيدتي </h4>
                <hr>
                <p>الان أبداع البحرين يقدم قروض صغيرة مخصصة للسيدات المنتجات في المنزل لغايات دعم مشاريعهن وتطويرها. تتراوح قيمة القرض بين 200 و 1000 دينار تسدد على مدة 12 شهر.</p>               <div class="box_shadow" >
                <p><b> شروط القرض: </p></b>
...
<!-- Services 2 -->
    <div class="modal fade ar-dir" id="ebdaaLoan" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6">
                  <img src="assets/img/loan/ebdaa.jpg" style="width:100%;">
                </div>
                <div class="col-sm-12 col-md-12 col-lg-6">
                   <h4>قرض الابداع </h4>
    			          <hr>
	                   <p> الأن ابداع البحرين يقدم قروض صغيرة مخصصة للذكور الذين لديهم مشاريع تدار من المنزل لغاية دعم مشاريعهم وتطويرها.</p>
    ...
    <div class="modal fade ar-dir" id="hopeLoan" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6">
                  <img  src="assets/img/loan/hope.jpg" style="width:100%;">
                </div>
              <div class="col-sm-12 col-md-12 col-lg-6">
                <h4>قرض الامل </h4>
 			          <hr>
                <p>الان أبداع البحرين يقدم قرض الامل المخصص لدعم المشاريع التجارية والخدماتية والصناعية بشروط ميسرة.</p>
...
<!-- Services 4 -->
    <div class="modal fade ar-dir" id="exellenceLoan" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6">
                  <img  src="assets/img/loan/excell.jpg" style="width:100%;">
                </div>
              <div class="col-sm-12 col-md-12 col-lg-6">
                <h4>قرض التميز</h4>
          <hr>
     <p>الان يقدم أبداع البحرين قرض التميز لدعم المشاريع التجارية والصناعية والخدماتية المرخصة وبشروط ميسرة.</p>
...
<!-- Services 5 -->
    <div class="modal fade ar-dir" id="seasonalLoan" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6">
                  <img  src="assets/img/loan/madares.jpg" style="width:100%;">
                </div>
              <div class="col-sm-12 col-md-12 col-lg-6">
                <h4>القرض الموسمي  </h4>
 			   <hr>
              <p>برسوم إدارية بسيطة و إجراءات سريعة و ميسرة شركة أبداع البحرين للتمويل متناهي الصغر يمنح اصحاب المشاريع الصغيرة فرصة شراء بضاعة اضافية للمدارس و تقسيطها على 24 شهر بحيث يبدأ السداد بعد نهاية الشهر </p>
			  <p>تبدأ قيمة القرض من 200 إلى 900 دينار تسدد على مدة 24 شهور. </p>
 			  <div class="box_shadow" >
 			  <p><b> شروط القرض: </p></b>
	...
	<!-- Services 6 -->
    <div class="modal fade ar-dir" id="TafawoqLoan" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6">
                  <img  src="assets/img/loan/tafawoq.jpg" style="width:100%;">
                </div>
              <div class="col-sm-12 col-md-12 col-lg-6">
                <h4>قرض التفوق  </h4>
 			   <hr>
                <p>الان يقدم أبداع البحرين قرض التفوق لدعم المشاريع التجارية والصناعية والخدماتية المرخصة و بشروط ميسرة.</p>
	...
	<!-- Services 7 -->
    <div class="modal fade ar-dir" id="NajahLoan" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6">
                  <img  src="assets/img/loan/najah.jpg" style="width:100%;">
                </div>
              <div class="col-sm-12 col-md-12 col-lg-6">
                <h4>قرض النجاح  </h4>
 			   <hr>
			   <p>الان يقدم أبداع البحرين قروض صغيرة لأصحاب المشاريع المنزلية والمتنقلة لغايات تطويرها وزيادة رأس مالها العامل.</p>
    ...
    <section id="application" class="section" data-stellar-background-ratio="0.09">
      <div class="container">
        <div class="section-header">
          <h2 class="section-title"> أستفسار عن قرض </h2>
          <hr class="lines">
          <p class="section-subtitle"> هل ترغب في الحصول على قرض  <br> أترك أسمك و رقم الهاتف <br> سيتواصل معاك فريق المبيعات في أقرب فرصة </p>
		  
        </div>
        <div class="row ar-dir">
          <div class="col-lg-12 col-sm-12 col-xs-12">
            <div class="contact-block">
              <form id="applicationForm" method="post" action="php/application-process.php">
                <div class="row">
                  <div class="col-md-6">
...
<!--
				  <div class="col-md-6">
                    <div class="form-group">
                    <select id="type_apply" name="type_apply" onchange="javascript: dynamicdropdown(this.options[this.selectedIndex].value);"  data-error="الرجاء اختيار نوع القرض">
...
و/أو دعائية و/أو وثائقية و/أو أي طريقة أخرى مهما كانت وبدون تحديد لمدة حق هذا الاستخدام قبل و/او أثناء و/او بعد انتهاء هذا القرض.</p>
                      ...
                      <p><b>سابعا </p></b>
                      <p> تعطي شركة ابداع البحرين للتمويل متناهي الصغر الحق في تزويد أي جهة رسمية أو خاصة سوأء أكانت محلية أو خارجية بأية معلومات وردت في هذا الطلب,
...
بتلك المعلومات ونتحمل أي تبعات في حال تبين أن هذه المعلومات غير حقيقية أو متضاربة مع تلك المعلومات الموجودة لدى تلك الجهات.</p>
					...
					<p>للتعرف على رسوم تقديم طلبات القروض ورسوم الخدمات الاخرى التي يقدمها البنك الرجاء <a href="UserFiles/files/Service%20Fees_new%202020-Ar11.pdf">الضغط هنا</a> </p>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4 mix stories_video">
                <div class="portfolio-item">
                  <div class="shot-item">
                      ...
                      <a href="#" class="overlay lightbox" data-toggle="modal" data-target="#story_1"><h1> وهيبه خليل</h1></a>
                    </li>
                  </div>
                </div>
              </div>
...
<div class="col-sm-6 col-md-4 col-lg-4 mix stories">
                <div class="portfolio-item">
                  <div class="shot-item">
                      ...
                      <a href="#" class="overlay lightbox" data-toggle="modal" data-target="#story_4"><h1> محمد عباس </h1></a>
                    </li>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4 mix stories_video">
                <div class="portfolio-item">
                  <div class="shot-item">
                      ...
                      <a href="#" class="overlay lightbox" data-toggle="modal" data-target="#story_3"><h1>  فاطمة محمد علي</h1></a>
                    </li>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4 mix stories_video">
                <div class="portfolio-item">
                  <div class="shot-item">
                      ...
                      <a href="#" class="overlay lightbox" data-toggle="modal" data-target="#story_5"><h1> سوسن محمد </h1></a>
                    </li>
                  </div>
                </div>
              </div>
...
<div class="col-sm-6 col-md-4 col-lg-4 mix stories">
                <div class="portfolio-item">
                  <div class="shot-item">
                      ...
                      <a href="#" class="overlay lightbox" data-toggle="modal" data-target="#story_7"><h1> عيسى علي</h1></a>
                    </li>
                  </div>
                </div>
              </div>
...
<div class="col-sm-6 col-md-4 col-lg-4 mix stories">
                <div class="portfolio-item">
                  <div class="shot-item">
                      ...
                      <a href="#" class="overlay lightbox" data-toggle="modal" data-target="#story_9"><h1>حميد عيد  </h1></a>
                    </li>
                  </div>
                </div>
              </div>
...
<div class="col-sm-6 col-md-4 col-lg-4 mix stories">
                <div class="portfolio-item">
                  <div class="shot-item">
                      ...
                      <a href="#" class="overlay lightbox" data-toggle="modal" data-target="#story_10"><h1> حمد شبيب  </h1></a>
                    </li>
                  </div>
                </div>
              </div>
...
<div class="col-sm-6 col-md-4 col-lg-4 mix stories">
                <div class="portfolio-item">
                  <div class="shot-item">
                      ...
                      <a href="#" class="overlay lightbox" data-toggle="modal" data-target="#story_6"><h1> أحمد جوهر</h1></a>
                    </li>
                  </div>
                </div>
              </div>
...
<div class="col-sm-6 col-md-4 col-lg-4 mix stories">
                <div class="portfolio-item">
                  <div class="shot-item">
                      ...
                      <a href="#" class="overlay lightbox" data-toggle="modal" data-target="#story_2"><h1> ساهرة إبراهيم </h1></a>
                    </li>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4 mix stories_video">
                <div class="portfolio-item">
                  <div class="shot-item">
                      ...
                      <a href="#" class="overlay lightbox" data-toggle="modal" data-target="#story_8"><h1>حسن محمد</h1></a>
                    </li>
                  </div>
                </div>
              </div>
...
<!--  Story_8  End-->
	...
	<!--  Story 1  popup-->
			  <div class="modal fade ar-dir" id="story_1" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-body ar-txt">
...
<!-- srory_2 popup  -->
<div class="modal fade ar-dir" id="story_2" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <div class="row">
...
<!--  Story 2  popup end-->
 ...
 <!--  Story_3  popup-->
			  <div class="modal fade ar-dir" id="story_3" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-body ar-txt">
...
<!--  Story_5  popup-->
			  <div class="modal fade ar-dir" id="story_5" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-body ar-txt">
...
<!--  Story 5  popup end-->
	  ...
	  <!-- srory_4 popup  -->
<div class="modal fade ar-dir" id="story_4" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <div class="row">
	...
	<!--  Story_4 popup End-->
		  ...
		  <!-- srory_6 popup  -->
<div class="modal fade ar-dir" id="story_6" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <div class="row">
	...
	<!--  Story_6  End-->
	  <!-- srory_7 popup  -->
<div class="modal fade ar-dir" id="story_7" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <div class="row">
	...
	<!--  Story_7  End-->
<!--  Story_8  popup-->
			  <div class="modal fade ar-dir" id="story_8" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-body ar-txt">
...
<!--  Story_8  End-->
 <!-- srory_9 popup  -->
<div class="modal fade ar-dir" id="story_9" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <div class="row">
	...
	<!--  Story_9  End-->
	<!-- srory_10 popup  -->
<div class="modal fade ar-dir" id="story_10" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <div class="row">
              ...
              <span aria-hidden="true">&times;</span>
				...
				<h4>إضافة نشاط</h4>
                <hr>
                  <div id="slides_story_10" class="carousel slide" data-ride="carousel">
    ...
    <div class="counters section ar-dir" data-stellar-background-ratio="0.5">
      <div class="container">
          <p style="bottom: 0;color: white;font-size:11px;text-align: center;"> اخر تحديث لهذه الأرقام تم ب 01\07\2021 </p>
        <div class="row">
          <div class="col-sm-6 col-md-3 col-lg-3 hoverable">
            <div class="facts-item normal">
              <div class="icon">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12" style="padding-bottom: 20px;">
            <div class="single-team">
             <a href="#" data-toggle="modal" data-target="#Khaled"> <img src="assets/img/team/Khaled.jpg" alt=""></a>
              <div class="team-details">
                <div class="team-inner">
                  <a href="#" data-toggle="modal" data-target="#Khaled"><h4 class="team-title">خالد الغزاوي</h4>
                  <p>الرئيس التنفيذي</p></a>
				  <a href="#" class="btn btn-link" data-toggle="modal" data-target="#Khaled" style="color:#61D2B4">السيرة الذاتية </a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="single-team">
             <a href="#" data-toggle="modal" data-target="#Yousef"> <img class="img-fulid" src="assets/img/team/Yousef.jpg" alt=""></a>
              <div class="team-details">
                <div class="team-inner">
                 <a href="#" data-toggle="modal" data-target="#Yousef"><h4 class="team-title">يوسف قمبر</h4>
                  <p>مسؤول موارد بشرية وإدارية</p></a>
				  <a href="#" class="btn btn-link" data-toggle="modal" data-target="#Yousef" style="color:#61D2B4">السيرة الذاتية </a>
                </div>
              </div>
            </div>
          </div>
		  ...
		  <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
             <a href="#" data-toggle="modal" data-target="#ali"> <img class="img-fulid" src="assets/img/team/ali.jpg" alt=""></a>
              <div class="team-details">
                <div class="team-inner">
                  <a href="#" data-toggle="modal" data-target="#ali"><h4 class="team-title"> علي عيسى محمد  </h4>
                  <p>مسؤول تكنولوجيا المعلومات</p></a>
				  <a href="#" class="btn btn-link" data-toggle="modal" data-target="#ali" style="color:#61D2B4"> السيرة الذاتية </a>
                </div>
              </div>
            </div>
          </div> 
           ...
           <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              ...
              <div class="team-details">
                <div class="team-inner">
                  <a href="#" data-toggle="modal" data-target="#Hana"><h4 class="team-title"> هناء سلمان </h4>
                  <p> مسؤول أول أتمان </p></a>
				  <a href="#" class="btn btn-link" data-toggle="modal" data-target="#Hana" style="color:#61D2B4">السيرة الذاتية </a>
                </div>
              </div>
            </div>
          </div> 
		...
		<!--    <div class="col-lg-3 col-md-6 col-xs-12">
		  ...
		  <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              ...
              <div class="team-details">
                <div class="team-inner">
                 <a href="#" data-toggle="modal" data-target="#Mashael"> <h4 class="team-title">مشاعل صالح</h4>
                  <p>مدير مالي</p></a>
				  <a href="#" class="btn btn-link" data-toggle="modal" data-target="#Mashael" style="color:#61D2B4">السيرة الذاتية </a>
                </div>
              </div>
            </div>
          </div>
		  ...
		  <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              ...
              <div class="team-details">
                <div class="team-inner">
                  <a href="#" data-toggle="modal" data-target="#hamza_new"><h4 class="team-title">حمزة القطيشات</h4>
                  <p>مسؤول أول تحصيل </p></a>
				  <a href="#" class="btn btn-link" data-toggle="modal" data-target="#hamza_new" style="color:#61D2B4">السيرة الذاتية </a>
                </div>
              </div>
            </div>
          </div>
	...
	<div class="modal fade ar-dir" id="Khaled" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="col-sm-12 col-md-12 col-lg-6">
                ...
                <hr>
               <div class="box_shadow" >
			   <p>في 2014/04/01، انضم د. خالد وليد الغزاوي كرئيس تنفيذي لبنك الإبداع للتمويل متناهي الصغر في البحرين حاملاً معه ما يزيد عن 19 عاماً من الخبرة في مجال التمويل الأصغر وأكثر من ثمانية سنوات من الخبرة في القطاع المالي والمصرفي. </P>
	...
	<div class="modal fade ar-dir" id="Ghaith" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="col-sm-12 col-md-12 col-lg-6">
                ...
                <hr>
               <div class="box_shadow" >
		   <p>يعمل السيد غيث في صناعة التمويل الأصغر منذ بدايات العام 2011 عندما انضم لأسرة الإبداع للتمويل متناهي الصغر في سوريا في 1 أبريل 2011، وتدرج في عدة مناصب وظيفية حتى وصل إلى منصب مدير فرع بداية عام 2016، لكن ظروف الحرب المأساوية هناك اضطرته للمغادرة لينتقل بعدها للعمل في أبداع البحرين. </P>
	...
	<div class="modal fade ar-dir" id="Hana" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
	...
	<div class="modal fade ar-dir" id="Firas" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
	...
	<div class="modal fade ar-dir" id="Yousef" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
	...
	<div class="modal fade ar-dir" id="ali" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
	...
	<div class="modal fade ar-dir" id="ِAhmed" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6">
                  <img src="assets/img/team/ِAhmed.jpg" alt="" style="width:100%;">
                </div>
              <div class="col-sm-12 col-md-12 col-lg-6">
                <h4> أحمد العرادي </h4>
	...
	<div class="modal fade ar-dir" id="Mashael" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
    ...
    <div class="modal fade ar-dir" id="hamza_new" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ar-txt">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
    ...
    <div id="testimonial" class="section" data-stellar-background-ratio="0.1 ar-dir" style="direction:ltr !important;">
      <div class="container">
        <div class="row justify-content-md-center">
          <div class="col-md-12">
			...
			<div class="testimonial-item ">
			  ...
			  <div class="testimonial-item ">
                ...
                <div class="testimonial-text">
                  <p> تنعم كل امرأة بإمكانيات غير محدودة لتحقيق المستحيل &nbsp <span class="fa fa-quote-right"></span> <br> <span class="fa fa-quote-left"></span>  &nbsp إذا كان عندها الارادة والإيمان بقدراتها </p>
                  <h3>منى المؤيد</h3>
         ...
         <!--     <div class="testimonial-item ">
              ...
              <div class="testimonial-item ">
                ...
                <div class="testimonial-text">
                  <p>نحرص دائما على الإرتقاء بخدماتنا إلى المستوى&nbsp <span class="fa fa-quote-right"></span> <br> <span class="fa fa-quote-left"></span>  &nbsp الذي يساعد عملائنا على تطوير مشاريعهم وزيادة دخلهم</p>
                  <h3>محمد الحداد</h3>
                  <span> مدير فرع </span>
                </div>
              </div>
              ...
              <div class="blog-item-wrapper">
                <li>
                  ...
                  <div class="blog-item-text">
                      ...
                      <h3><a href="#" data-toggle="modal" data-target="#News18">"أبداع البحرين يهنئ السيدة منى المؤيد بمواصلة تصدرها قائمة "فوربس"</a></h3>
					  <p>
				  ...
				  <a href="#" class="btn btn-link" data-toggle="modal" data-target="#News18" style="color:#61D2B4">تفاصيل الخبر  <i class="lnr lnr-arrow-left"></i></a>
                  </div>
			          </li>
              </div>
            </div>
              ...
              <div class="blog-item-wrapper">
                <li>
                  ...
                  <div class="blog-item-text">
	                ...
	                <h3><a href="#" data-toggle="modal" data-target="#News17">أبداع البحرين يحقق أرباحا بلغت 306 آلاف دينار عام 2018 </a></h3>
					<p>
                    ...
                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#News17" style="color:#61D2B4">تفاصيل الخبر  <i class="lnr lnr-arrow-left"></i></a>
                  </div>
			          </li>
              </div>
            </div>
              ...
              <div class="blog-item-wrapper">
                <li>
                  ...
                  <div class="blog-item-text">
                    ...
                    <h3><a href="#" data-toggle="modal" data-target="#News16">الغزاوي يستعرض تجربة البحرين في تطبيق التكنولوجيا في الخدمات المالية</a></h3>
                    <p>
                    ...
                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#News16" style="color:#61D2B4">تفاصيل الخبر  <i class="lnr lnr-arrow-left"></i></a>
                  </div>
			          </li>
              </div>
            </div>
              ...
              <div class="blog-item-wrapper">
                <li>
                  ...
                  <div class="blog-item-text">
                    ...
                    <h3><a href="#" data-toggle="modal" data-target="#News15"> «أبداع البحرين» يقدم فرصا وظيفية في «معرض التدريب والتعليم»</a></h3>
                    <p>
شاركت شركة الإبداع للتمويل المتناهي الصغر في معرض البحرين للتدريب والتعليم ما قبل العمل 2019 الذي أقيم تحت رعاية جميل بن علي حميدان وزير العمل والتنمية الاجتماعية، إلى جوار نحو ستين جهة من القطاعين العام والخاص تعمل في مجال التعليم والتدريب والتوظيف.
                    ...
                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#News15" style="color:#61D2B4">تفاصيل الخبر  <i class="lnr lnr-arrow-left"></i></a>
                  </div>
			          </li>
              </div>
            </div>
              ...
              <div class="blog-item-wrapper">
                <li>
                  ...
                  <div class="blog-item-text">
                      ...
                      <h3><a href="#" data-toggle="modal" data-target="#News14">الرئيس التنفيذي لبنك البحرين للتنمية عضوًا في مجلس إدارة ِشركة ابداع البحرين </a></h3>
					  <p>
                   إدارة ِشركة ابداع البحرين للتمويل المتناهي الصغر انضمام سانجيف بول الرئيس التنفيذي لبنك البحرين للتنمية إلى عضوية مجلس إدارته لما تبقى من دورة المجلس الحالية. يأتي انضمام بول إلى عضوية المجلس خلفًا للسيدة دلال اسماعيل التي مثلت بنك البحرين للتنمية على مجلس إدارة أبداع البحرين لأكثر من 5 سنوات.
                    ...
                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#News14" style="color:#61D2B4">تفاصيل الخبر  <i class="lnr lnr-arrow-left"></i></a>
                  </div>
			          </li>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
              <div class="blog-item-wrapper">
                <li>
                  <div class="blog-item-img">
                    <a href="#" data-toggle="modal" data-target="#News13"><img src="assets/img/news/news_shomol.jpg" alt=""></a>
                  </div>
                  <br>
                  <div class="blog-item-text">
                    <h3><a href="#" data-toggle="modal" data-target="#News13">"الإبداع" يستعرض بجنيف تجربة البحرين في تمكين المرأة والشباب اقتصادياً</a></h3>
                    <p>
                    ...
                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#News13" style="color:#61D2B4">تفاصيل الخبر  <i class="lnr lnr-arrow-left"></i></a>
                  </div>
			          </li>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
              <div class="blog-item-wrapper">
                <li>
                  ...
                  <br>
                  <div class="blog-item-text">
                    <h3><a href="#" data-toggle="modal" data-target="#News12">ممثلون عن 10 مؤسسات تمويل أصغر عربية يشاركون في ورشة عمل بالبحرين</a></h3>
                    <p>
                    ...
                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#News12" style="color:#61D2B4">تفاصيل الخبر  <i class="lnr lnr-arrow-left"></i></a>
                  </div>
			          </li>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
              <div class="blog-item-wrapper">
                <li>
                  ...
                  <div class="blog-item-text">
                    <h3><a href="#" data-toggle="modal" data-target="#News0">تعاون مشترك بين أبداع البحرين ومكتب الأمم المتحدة لدعم التنمية المستدامة</a></h3>
                    <p>
                    ...
                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#News0" style="color:#61D2B4">تفاصيل الخبر  <i class="lnr lnr-arrow-left"></i></a>
                  </div>
			          </li>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
              <div class="blog-item-wrapper">
                <li>
                  ...
                  <div class="blog-item-text">
                    <h3><a href="#" data-toggle="modal" data-target="#News1">"القصيبي القابضة" تقدم 100 ألف دينار بحريني دعما الى أبداع البحرين</a></h3>
                    <p>
                    ...
                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#News1" style="color:#61D2B4">تفاصيل الخبر  <i class="lnr lnr-arrow-left"></i></a>
                  </div>
			          </li>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
              <div class="blog-item-wrapper">
                <li>
                  ...
                  <div class="blog-item-text">
                   <h3><a href="#" data-toggle="modal" data-target="#News2">أبداع البحرين للتمويل متناهي الصغر يطلق قرضي "النجاح" و"التفوق"</a></h3>
				   <p>
                    ...
                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#News2" style="color:#61D2B4">تفاصيل الخبر  <i class="lnr lnr-arrow-left"></i></a>
                  </div>
			          </li>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
              <div class="blog-item-wrapper">
                <li>
                  ...
                  <div class="blog-item-text">
                    <h3><a href="#" data-toggle="modal" data-target="#News3"> أبداع البحرين " يعيد افتتاح فرعه بمدينة حمد بعد تطويره خدمةً للعملاء"</a></h3>
                    ...
                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#News3" style="color:#61D2B4">تفاصيل الخبر  <i class="lnr lnr-arrow-left"></i></a>
                  </div>
			          </li>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
              <div class="blog-item-wrapper">
                <li>
                  ...
                  <div class="blog-item-text">
                    <h3><a href="#" data-toggle="modal" data-target="#News4"> أبداع البحرين للتمويل متناهي الصغر يحتفي بكوادره</a></h3>
                    <p>
                    ...
                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#News4" style="color:#61D2B4">تفاصيل الخبر  <i class="lnr lnr-arrow-left"></i></a>
                  </div>
			          </li>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
              <div class="blog-item-wrapper">
                <li>
                  ...
                  <div class="blog-item-text">
                    <h3><a href="#" data-toggle="modal" data-target="#News5">د. الغزاوي يدعو من القاهرة لتكامل صناعة التمويل الأصغر بالوطن العربي</a></h3>
                    <p>
                    ...
                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#News5" style="color:#61D2B4">تفاصيل الخبر  <i class="lnr lnr-arrow-left"></i></a>
                  </div>
			          </li>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
              <div class="blog-item-wrapper">
                <li>
                  ...
                  <div class="blog-item-text">
                    <h3><a href="#" data-toggle="modal" data-target="#News6"> أبداع البحرين راعيا حصريا لحملة "نعين ونتعاون" في جامعة البحرين</a></h3>
                    <p>
                    ...
                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#News6" style="color:#61D2B4">تفاصيل الخبر  <i class="lnr lnr-arrow-left"></i></a>
                  </div>
			          </li>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
              <div class="blog-item-wrapper">
                <li>
                  ...
                  <div class="blog-item-text">
	                <h3><a href="#" data-toggle="modal" data-target="#News7"> يتبنى أبداع البحرين استراتيجية جديدة متوافقة مع أهداف التنمية المستدامة في البحرين</a></h3>
					<p>
                    ...
                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#News7" style="color:#61D2B4">تفاصيل الخبر  <i class="lnr lnr-arrow-left"></i></a>
                  </div>
			          </li>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
              <div class="blog-item-wrapper">
                <li>
                  ...
                  <div class="blog-item-text">
                    <h3><a href="#" data-toggle="modal" data-target="#News8">د. الغزاوي: نقل تجربة البحرين في التمويل الأصغر للعراق</a></h3>
                    <p>
                    ...
                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#News8" style="color:#61D2B4">تفاصيل الخبر  <i class="lnr lnr-arrow-left"></i></a>
                  </div>
			          </li>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
              <div class="blog-item-wrapper">
                <li>
                  ...
                  <div class="blog-item-text">
                    <h3><a href="#" data-toggle="modal" data-target="#News9">د. الغزاوي يدعو لتبني مفهوم التمويل الأصغر في المؤسسات الخيرية الخليجية</a></h3>
                    <p>
                    ...
                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#News9" style="color:#61D2B4">تفاصيل الخبر  <i class="lnr lnr-arrow-left"></i></a>
                  </div>
			          </li>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
              <div class="blog-item-wrapper">
                <li>
                  ...
                  <div class="blog-item-text">
                  <h3><a href="#" data-toggle="modal" data-target="#News10">أبداع البحرين يحتفي بموظفيه الأكثر إنتاجية</a></h3>
				  <p>
                   كرَّم الرئيس التنفيذي لشركة الابداع للتمويل متناهي الصغر ، الدكتور خالد وليد الغزاوي، عددا من كوادر البنك الذين أظهروا مستويات أداء متميزة خلال الآونة الأخيرة، وذلك ضمن برنامج البنك الرامي لتحفيز كوادره وتشجيعهم على تعزيز مستويات الأداء وزيادة الانتاجية وبما يعزز من خدمة عملاء البنك من البحرينيين والبحرانيات أصحاب المشاريع الصغيرة وتقديم التمويل اللازم لهم بطريقة ميسرة وفعالة.
                    ...
                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#News10" style="color:#61D2B4">تفاصيل الخبر  <i class="lnr lnr-arrow-left"></i></a>
                  </div>
			          </li>
              </div>
            </div>
...
<div class="modal fade ar-dir" id="News10" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <section id="contact" class="section" style="background-image: linear-gradient(#b1e9da, #ffffff);">
      <div class="container">
        <div class="section-header">
          ...
          <hr class="lines wow zoomIn" data-wow-delay="0.3s">
          <p class="section-subtitle wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">اذا كانت لديكم اي استفسار أو اقتراح أو شكوى حول خدمات أبداع البحرين ، الرجاء التواصل معنا <br>.رأيكم يهمنا وخدمتكم هدفنا</p>
		  </div>
                  ...
                  <div id="contact-address">
                    <div class="col-lg-6 col-sm-6 col-xs-12 contactBox" style="border-bottom: 2px solid #61D2B4; border-left: 2px solid #61D2B4">
                      ...
                      <ul style="text-align:right; padding-bottom:10px;direction:rtl;">
                        <li><a style=" padding: 7px 0px; color: #999; text-transform: capitalize;" href="tel:+973 17381000"><span class="fa fa-phone " style="padding-left:5px;"></span>973&nbsp;17381000+</a></li>
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-12 contactBox" style="border-bottom: 2px solid #61D2B4">
                      ...
                      <ul style="text-align:right ;padding-bottom:10px;">
                       <li> <a style=" padding: 7px 0px; color: #999; text-transform: capitalize;" href="tel:+973 17381003"><span class="fa fa-phone " style="padding-left:5px;"></span>973&nbsp;17381003+</a></li>
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-12 contactBox" style="border-left: 2px solid #61D2B4">
                      ...
                      <hr >
                      <ul style="text-align:right ;padding-bottom:10px;">
                        <li> <a style=" padding: 7px 0px; color: #999; text-transform: capitalize;" href="tel:+973 17381013"><span class="fa fa-phone " style="padding-left:5px;"></span>973&nbsp;17381013+</a></li>
					...
					<div class="col-lg-6 col-sm-6 col-xs-12 contactBox">
                      ...
                      <hr>
                      <ul style="text-align:right;padding-bottom:10px;">
                        <li> <a style=" padding: 7px 0px; color: #999; text-transform: capitalize;" href="tel:+973 17381018"><span class="fa fa-phone " style="padding-left:5px;"></span>973&nbsp;17381012+</a></li>
                   ...
                   <div class="col-lg-6 col-sm-6 col-xs-12 contactBox" style="border-Top: 2px solid #61D2B4; border-left: 2px solid #61D2B4">
                      ...
                      <hr>
                      <ul style="text-align:right;padding-bottom:10px;">
                        <li> <a style=" padding: 7px 0px; color: #999; text-transform: capitalize;" href="tel:+973 17381018"><span class="fa fa-phone " style="padding-left:5px;"></span>973&nbsp;17381018+</a></li>
                ...
                <div class="contact-block">
                  <form id="contactForm">
                    <div class="">
                      <div class="col-md-12">
                        <div class="form-group">
                          <input type="text" id="name_contact" name="name_contact" placeholder="الاسم الرباعي" pattern="[A-Za-z\u0600-\u065F\u066A-\u06EF\u06FA-\u06FF\s]{3,30}" required data-error="الرجاء ادخال الاسم الرباعي ">
                          <div class="help-block with-errors"></div>
                        </div>
                      </div>
					  <div class="col-md-12">
					  <div class="form-group">
						  <input type="text" id="mobile_contact" name="mobile_contact" pattern="[0-9-]{8,15}" placeholder="رقم المحمول" required data-error="الرجاء ادخال رقم المحمول ">
                          <div class="help-block with-errors"></div>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                          <input type="email" placeholder="البريد الإلكتروني" id="email_contact" name="email_contact" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required data-error="الرجاء ادخال بريدك االإلكتروني ">
                          <div class="help-block with-errors"></div>
                        </div>
                      </div>
                      <div class="col-md-12">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <textarea  id="message_contact" placeholder="الرساله" rows="8" data-error="الرجاء ادخل رسالتك" pattern="[A-Za-z\u0600-\u065F\u066A-\u06EF\u06FA-\u06FF1-9-\,\.\?\!\@\s]{3,200}" required></textarea>
                          <div class="help-block with-errors"></div>
                        </div>
                        <div class="submit-button text-center">
        ...
        <p class="ar-txt ar-dir">**اذا كان لديك شكوى يمكنك  إرسال رسالة عن طريق<a href="#contact" class="btn-link " style="color:#61D2B4"><b> النموذج اعلاه </b></a>أو اتباع <a href="#" class="btn-link" data-toggle="modal" data-target="#complain" style="color:#61D2B4"><b>إجراءات الشكاوى</b></a> لنقوم بمساعدتك .</p>
        <p class="ar-txt ar-dir">** لعرض الوظائف الشاغرة يرجى <a href="#" class="btn-link" data-toggle="modal" data-target="#jobModal" style="color:#61D2B4"><b>الضغط هنا </b></a>.
        <!-- complain Modal -->
        <div class="modal fade ar-dir" id="complain" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-body">
                ...
                <div class="col-sm-12">
                  ...
                  <div class="box_shadow">
                    <p><b> اتبع هذه الخطوات الثلاث لتوصيل وجهة نظرك للمعنيين:</p></b>
                  </div>
                  </div>
                  ...
                  <div class="col-sm-12">
                    <div class="box_shadow" >
                      <p><b>ثالثا – إدارة المتابعة بمصرف البحرين المركزي</p></b>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-sm-6 col-xs-12">
            <div class="copyright">
              <p>جميع الحقوق محفوظة &copy; 2021 - تصميم و تطوير&nbsp; <a rel="nofollow" href="index.php"> أبداع البحرين </a><br>مرخص من قبل مصرف البحرين المركزي كمؤسسة تمويل أصغر تقليدية</p>
          ...
          <div class="col-lg-6 col-sm-6 col-xs-12">
            ...
            <ul class="footer-links ar-dir">
              ...
              <li><a href="#" data-toggle="modal" data-target="#jobModal">الوظائف </a></li>
              </ul>
    ...
    <!-- Jobs Modal -->
    <div class="modal fade ar-dir" id="jobModal" tabindex="-1" role="dialog" zaria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body ">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float:left">
			...
			<div class="row ar-txt">
              <div class="col-sm-12 col-md-6 col-lg-6">
			   <div class="row">
                <div id="accordion">
				<button name="job1" type="button" class="collapsible">أخصائي تحصيل</button>
                <div class="content">
                  <p>الهدف العام 
				  ...
				  <button name="job2" type="button" class="collapsible">أخصائي إقراض</button>
                  <div class="content">
                    <p>الهدف العام:
                ...
                <div class="contact-form">
                  <div class="container">
                      <div class="col-lg-12 col-sm-12 col-xs-12" style="direction:rtl;">
                        <div class="contact-block">
                          <form method="POST" id="jobsForm" action="php/jobs-process.php" role="form">
                            <div class="">
                              <div class="col-md-12">
                                <div class="form-group row">
								<label for="name_job" class="col-sm-3 col-form-label" >الإسم</label>
								<div class="col-sm-9">
                                  <input type="text" id="name_job" name="name_job" placeholder="الاسم" pattern="[A-Za-z\u0600-\u065F\u066A-\u06EF\u06FA-\u06FF\s]{3,30}" required data-error="الرجاء ادخال الاسم الرباعي ">
                                  </div>
								  <div class="help-block with-errors"></div>
                                </div>
                              </div>
                              <div class="col-md-12">
                                <div class="form-group row">
								<label for="email_job" class="col-sm-3 col-form-label" >البريد الإلكتروني</label>
								<div class="col-sm-9">
                                  <input type="email" placeholder="البريد الالكتروني" id="email_job" name="email_job" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required data-error="الرجاء ادخال بريدك الالكتروني">
                                  </div>
                              ...
                              <div class="col-md-12">
                                <div class="form-group row">
								<label for="cv_job" class="col-sm-3 col-form-label" >السيرة الذاتية</label>
								<div class="col-sm-9">
                                  <input type="file" placeholder="رفع السيره الذاتيه" id="cv_job" name="file_attach[]" required data-error="الرجاء رفع السيره الذاتيه" accept=".doc, .docx, .txt, application/pdf">
                                 </div>
								 <div class="help-block with-errors"></div>
                                </div>
                              ...
                              <div class="col-md-12">
                                <div class="form-group row">
								<label for="job_type" class="col-sm-3 col-form-label" >الوظيفة</label>
                                  <div class="col-sm-9">
								  <select id="job_type" name="job_type" form="contact_body">
                              ...
                              <div class="col-md-19">
                                <div class="form-group row">
                                  <textarea  id="message_job" name="message_job" placeholder="الرساله" rows="8"  pattern="[A-Za-z\u0600-\u065F\u066A-\u06EF\u06FA-\u06FF1-9-\,\.\?\!\@\s]{3,200}" data-error="الرجاء كتابه الرسالة" ></textarea>
                                  <div class="help-block with-errors"></div>						
                                </div>
								</div>
								...
								<div class="g-recaptcha" data-sitekey="6LetsOQZAAAAANG2gbEt7vMzNEFNHMry4QKYdVJ5" data-size="visible" data-callback="verifyRecaptchCallback" data-expired-callback="expiredRecaptchaCallback"></div>
								<div class= "from-group">
								</div>
								<div class="submit-button text-left">
								<button class="btn btn-common" id="submit_job" type="submit">تقدم للوظيفه</button>
                                <div id="msgSubmit-job" class="h3 text-left hidden"></div>
                                <div class="clearfix"></div>
                               </div>
                             </div>
                           </form>
