...
$text=str_replace("[dot","<LI",$text); // dot at the beggining
$text=str_replace("[line","<hr",$text);  // line
$text=str_replace("[quote","<table cellspacing=0 cellpadding=0 border=1 width=60%><tr><td align=center",$text); //quote
